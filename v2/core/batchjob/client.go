...
//
// [migration guide]: https://github.com/stripe/stripe-go/wiki/Migration-guide-for-Stripe-Client
func (c Client) Get(id string, params *stripe.V2CoreBatchJobParams) (*stripe.V2CoreBatchJob, error) {
	path := stripe.FormatURLPath("/v2/core/batch_jobs/%s", id)
	batchjob := &stripe.V2CoreBatchJob{}
...
//
// [migration guide]: https://github.com/stripe/stripe-go/wiki/Migration-guide-for-Stripe-Client
func (c Client) Cancel(id string, params *stripe.V2CoreBatchJobCancelParams) (*stripe.V2CoreBatchJob, error) {
	path := stripe.FormatURLPath("/v2/core/batch_jobs/%s/cancel", id)
	batchjob := &stripe.V2CoreBatchJob{}
