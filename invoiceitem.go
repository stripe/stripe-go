...
type InvoiceItemDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *InvoiceItemDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
...
type InvoiceItemDiscountParams struct {
	...
	// Details to determine how long the discount should be applied for.
	DiscountEnd *InvoiceItemDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
...
type InvoiceItemUpdateDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *InvoiceItemUpdateDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
type InvoiceItemUpdateDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *InvoiceItemUpdateDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
}
...
type InvoiceItemCreateDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *InvoiceItemCreateDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
type InvoiceItemCreateDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *InvoiceItemCreateDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
}
...
type InvoiceItemParent struct {
	// Details about the pricing plan subscription that generated this invoice item
	PricingPlanSubscriptionDetails *InvoiceItemParentPricingPlanSubscriptionDetails `json:"pricing_plan_subscription_details,omitempty"`
	// Details about the rate card subscription that generated this invoice item
	RateCardSubscriptionDetails *InvoiceItemParentRateCardSubscriptionDetails `json:"rate_card_subscription_details,omitempty"`
	// Details about the subscription schedule that generated this invoice item
	ScheduleDetails *InvoiceItemParentScheduleDetails `json:"schedule_details,omitempty"`
	// Details about the subscription that generated this invoice item
...
type InvoiceItemPricing struct {
	LicenseFeeDetails                           *InvoiceItemPricingLicenseFeeDetails                           `json:"license_fee_details,omitempty"`
	PriceDetails                                *InvoiceItemPricingPriceDetails                                `json:"price_details,omitempty"`
	RateCardCustomPricingUnitOverageRateDetails *InvoiceItemPricingRateCardCustomPricingUnitOverageRateDetails `json:"rate_card_custom_pricing_unit_overage_rate_details,omitempty"`
	RateCardRateDetails                         *InvoiceItemPricingRateCardRateDetails                         `json:"rate_card_rate_details,omitempty"`
	// The type of the pricing details.
...
type InvoiceItemProrationDetailsCreditedItems struct {
	...
	InvoiceLineItemDetails *InvoiceItemProrationDetailsCreditedItemsInvoiceLineItemDetails `json:"invoice_line_item_details,omitempty"`
	// Whether the credit references a pending invoice item or one or more invoice line items on an invoice.
