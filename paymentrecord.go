...
type PaymentRecordPaymentMethodDetails struct {
	...
	Gopay           *PaymentRecordPaymentMethodDetailsGopay           `json:"gopay"`
	Grabpay         *PaymentRecordPaymentMethodDetailsGrabpay         `json:"grabpay"`
	IDBankTransfer  *PaymentRecordPaymentMethodDetailsIDBankTransfer  `json:"id_bank_transfer"`
	...
	Qris               *PaymentRecordPaymentMethodDetailsQris               `json:"qris"`
	Rechnung           *PaymentRecordPaymentMethodDetailsRechnung           `json:"rechnung"`
