...
const (
	...
	PaymentRecordPaymentMethodDetailsCryptoNetworkSui      PaymentRecordPaymentMethodDetailsCryptoNetwork = "sui"
...
const (
	...
	PaymentRecordPaymentMethodDetailsCryptoTokenCurrencyUsdsui      PaymentRecordPaymentMethodDetailsCryptoTokenCurrency = "usdsui"
...
type PaymentRecordPaymentMethodDetailsGiftCardBrand string

// List of values that PaymentRecordPaymentMethodDetailsGiftCardBrand can take
const (
	PaymentRecordPaymentMethodDetailsGiftCardBrandFiservValuelink PaymentRecordPaymentMethodDetailsGiftCardBrand = "fiserv_valuelink"
	PaymentRecordPaymentMethodDetailsGiftCardBrandGivex           PaymentRecordPaymentMethodDetailsGiftCardBrand = "givex"
	PaymentRecordPaymentMethodDetailsGiftCardBrandSvs             PaymentRecordPaymentMethodDetailsGiftCardBrand = "svs"
)

// Bank where the account is located.
type PaymentRecordPaymentMethodDetailsIDBankTransferBank string

// List of values that PaymentRecordPaymentMethodDetailsIDBankTransferBank can take
const (
	PaymentRecordPaymentMethodDetailsIDBankTransferBankBca     PaymentRecordPaymentMethodDetailsIDBankTransferBank = "bca"
	PaymentRecordPaymentMethodDetailsIDBankTransferBankBni     PaymentRecordPaymentMethodDetailsIDBankTransferBank = "bni"
	PaymentRecordPaymentMethodDetailsIDBankTransferBankBri     PaymentRecordPaymentMethodDetailsIDBankTransferBank = "bri"
	PaymentRecordPaymentMethodDetailsIDBankTransferBankCimb    PaymentRecordPaymentMethodDetailsIDBankTransferBank = "cimb"
...
type PaymentRecordReportPaymentAttemptFailedParams struct {
	...
	PaymentMethodDetails *PaymentRecordReportPaymentAttemptFailedPaymentMethodDetailsParams `form:"payment_method_details" json:"payment_method_details,omitempty"`
	// Processor information for this payment.
...
// Verification checks performed on the card.
type PaymentRecordReportPaymentAttemptFailedPaymentMethodDetailsCardChecksParams struct {
	// The result of the check on the cardholder's address line 1.
	AddressLine1Check *string `form:"address_line1_check" json:"address_line1_check,omitempty"`
	// The result of the check on the cardholder's postal code.
	AddressPostalCodeCheck *string `form:"address_postal_code_check" json:"address_postal_code_check,omitempty"`
...
// Information about the card payment method used to make this payment.
type PaymentRecordReportPaymentAttemptFailedPaymentMethodDetailsCardParams struct {
	// Verification checks performed on the card.
	Checks *PaymentRecordReportPaymentAttemptFailedPaymentMethodDetailsCardChecksParams `form:"checks" json:"checks,omitempty"`
}
...
type PaymentRecordReportRefundFailedParams struct {
...
type PaymentRecordReportRefundParams struct {
	...
	Expand []*string `form:"expand" json:"expand,omitempty"`
	// Information about the refund failure.
	Failed *PaymentRecordReportRefundFailedParams `form:"failed" json:"failed,omitempty"`
...
type PaymentRecordPaymentMethodDetailsBizum struct {
...
type PaymentRecordPaymentMethodDetailsCardPresent struct {
	...
	// Whether the PaymentIntent can be reauthorized or not.
	Reauthorization *PaymentRecordPaymentMethodDetailsCardPresentReauthorization `json:"reauthorization,omitempty"`
...
type PaymentRecordPaymentMethodDetailsGiftCardBalance struct {
	// The balance amount in the smallest currency unit.
	Amount int64 `json:"amount"`
	// The currency of the balance.
	Currency Currency `json:"currency"`
}
type PaymentRecordPaymentMethodDetailsGiftCard struct {
	// The balance of the gift card after the transaction.
	Balance *PaymentRecordPaymentMethodDetailsGiftCardBalance `json:"balance"`
	// The brand of the gift card.
	Brand PaymentRecordPaymentMethodDetailsGiftCardBrand `json:"brand"`
...
type PaymentRecordPaymentMethodDetailsIDBankTransfer struct {
	// Account number of the bank account to transfer funds to.
	AccountNumber string `json:"account_number"`
	// Bank where the account is located.
	Bank PaymentRecordPaymentMethodDetailsIDBankTransferBank `json:"bank"`
...
type PaymentRecordPaymentMethodDetailsScalapay struct {
...
type PaymentRecordPaymentMethodDetailsTamara struct {
...
type PaymentRecordPaymentMethodDetails struct {
	...
	Bizum          *PaymentRecordPaymentMethodDetailsBizum          `json:"bizum,omitempty"`
	...
	GiftCard        *PaymentRecordPaymentMethodDetailsGiftCard        `json:"gift_card,omitempty"`
	Giropay         *PaymentRecordPaymentMethodDetailsGiropay         `json:"giropay,omitempty"`
	Gopay           *PaymentRecordPaymentMethodDetailsGopay           `json:"gopay,omitempty"`
	Grabpay         *PaymentRecordPaymentMethodDetailsGrabpay         `json:"grabpay,omitempty"`
	IDBankTransfer  *PaymentRecordPaymentMethodDetailsIDBankTransfer  `json:"id_bank_transfer,omitempty"`
	...
	Paypay             *PaymentRecordPaymentMethodDetailsPaypay             `json:"paypay,omitempty"`
	...
	Qris               *PaymentRecordPaymentMethodDetailsQris               `json:"qris,omitempty"`
	Rechnung           *PaymentRecordPaymentMethodDetailsRechnung           `json:"rechnung,omitempty"`
	...
	StripeBalance      *PaymentRecordPaymentMethodDetailsStripeBalance      `json:"stripe_balance,omitempty"`
	...
	Tamara             *PaymentRecordPaymentMethodDetailsTamara             `json:"tamara,omitempty"`
