...
type BalanceTransitBalancesTotalAvailable struct {
	...
	// Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
	Currency    Currency                                         `json:"currency"`
	SourceTypes *BalanceTransitBalancesTotalAvailableSourceTypes `json:"source_types,omitempty"`
}
...
type BalanceTransitBalancesTotalPending struct {
	...
	// Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
	Currency    Currency                                       `json:"currency"`
	SourceTypes *BalanceTransitBalancesTotalPendingSourceTypes `json:"source_types,omitempty"`
}
