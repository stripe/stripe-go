...
type ChargePaymentMethodDetailsGiftCardBrand string

// List of values that ChargePaymentMethodDetailsGiftCardBrand can take
const (
	ChargePaymentMethodDetailsGiftCardBrandFiservValuelink ChargePaymentMethodDetailsGiftCardBrand = "fiserv_valuelink"
	ChargePaymentMethodDetailsGiftCardBrandGivex           ChargePaymentMethodDetailsGiftCardBrand = "givex"
	ChargePaymentMethodDetailsGiftCardBrandSvs             ChargePaymentMethodDetailsGiftCardBrand = "svs"
)
...
type ChargePaymentDetailsParams struct {
	...
	// Fleet data for this PaymentIntent.
	FleetData []*ChargePaymentDetailsFleetDatumParams `form:"fleet_data" json:"fleet_data,omitempty"`
	// Flight reservation details for this PaymentIntent
...
type ChargeCapturePaymentDetailsParams struct {
	...
	// Fleet data for this PaymentIntent.
	FleetData []*ChargeCapturePaymentDetailsFleetDatumParams `form:"fleet_data" json:"fleet_data,omitempty"`
	// Flight reservation details for this PaymentIntent
...
type ChargeUpdatePaymentDetailsParams struct {
	...
	// Fleet data for this PaymentIntent.
	FleetData []*ChargeUpdatePaymentDetailsFleetDatumParams `form:"fleet_data" json:"fleet_data,omitempty"`
	// Flight reservation details for this PaymentIntent
...
type ChargePaymentMethodDetailsCard struct {
	...
	Benefits          *ChargePaymentMethodDetailsCardBenefits `json:"benefits,omitempty"`
	// Card brand. Can be `amex`, `cartes_bancaires`, `diners`, `discover`, `eftpos_au`, `jcb`, `link`, `mastercard`, `unionpay`, `visa` or `unknown`.
	...
	// Whether the PaymentIntent can be reauthorized or not.
	Reauthorization *ChargePaymentMethodDetailsCardReauthorization `json:"reauthorization,omitempty"`
...
type ChargePaymentMethodDetailsCardPresent struct {
	...
	// Whether the PaymentIntent can be reauthorized or not.
	Reauthorization *ChargePaymentMethodDetailsCardPresentReauthorization `json:"reauthorization,omitempty"`
	// The time at which the associated PaymentIntent will transition to a terminal state if it is not reauthorized.
	ReauthorizeBefore int64 `json:"reauthorize_before,omitempty"`
	// A collection of fields required to be displayed on receipts. Only required for EMV transactions.
...
type ChargePaymentMethodDetailsGiftCardBalance struct {
	// The balance amount in the smallest currency unit.
	Amount int64 `json:"amount"`
	// The currency of the balance.
	Currency Currency `json:"currency"`
}
type ChargePaymentMethodDetailsGiftCard struct {
	Balance *ChargePaymentMethodDetailsGiftCardBalance `json:"balance"`
	// The brand of the gift card.
	Brand ChargePaymentMethodDetailsGiftCardBrand `json:"brand"`
...
type ChargePaymentMethodDetailsScalapay struct {
...
type ChargePaymentMethodDetailsTamara struct {
...
type ChargePaymentMethodDetails struct {
	...
	Bizum              *ChargePaymentMethodDetailsBizum              `json:"bizum,omitempty"`
	...
	GiftCard           *ChargePaymentMethodDetailsGiftCard           `json:"gift_card,omitempty"`
...
type Charge struct {
	...
	AllocatedFunds *TransitBalance `json:"allocated_funds,omitempty"`
	// Amount intended to be collected by this payment. A positive integer representing how much to charge in the [smallest currency unit](https://docs.stripe.com/currencies#zero-decimal) (e.g., 100 cents to charge $1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is $0.50 US or [equivalent in charge currency](https://docs.stripe.com/currencies#minimum-and-maximum-charge-amounts). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of $999,999.99).
	Amount int64 `json:"amount"`
