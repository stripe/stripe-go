...
import (
	...
	"github.com/stripe/stripe-go/v86/accountnotice"
	...
	billingmetereventsummary "github.com/stripe/stripe-go/v86/billing/metereventsummary"
	billingportalconfiguration "github.com/stripe/stripe-go/v86/billingportal/configuration"
	billingportalsession "github.com/stripe/stripe-go/v86/billingportal/session"
	"github.com/stripe/stripe-go/v86/capability"
	capitalfinancingoffer "github.com/stripe/stripe-go/v86/capital/financingoffer"
	capitalfinancingsummary "github.com/stripe/stripe-go/v86/capital/financingsummary"
	capitalfinancingtransaction "github.com/stripe/stripe-go/v86/capital/financingtransaction"
	"github.com/stripe/stripe-go/v86/card"
	"github.com/stripe/stripe-go/v86/cashbalance"
	"github.com/stripe/stripe-go/v86/charge"
	checkoutsession "github.com/stripe/stripe-go/v86/checkout/session"
	climateorder "github.com/stripe/stripe-go/v86/climate/order"
	climateproduct "github.com/stripe/stripe-go/v86/climate/product"
	climatesupplier "github.com/stripe/stripe-go/v86/climate/supplier"
	"github.com/stripe/stripe-go/v86/confirmationtoken"
	...
	entitlementsactiveentitlement "github.com/stripe/stripe-go/v86/entitlements/activeentitlement"
	entitlementsfeature "github.com/stripe/stripe-go/v86/entitlements/feature"
	"github.com/stripe/stripe-go/v86/ephemeralkey"
	"github.com/stripe/stripe-go/v86/event"
	"github.com/stripe/stripe-go/v86/externalaccount"
	"github.com/stripe/stripe-go/v86/feerefund"
	"github.com/stripe/stripe-go/v86/file"
	"github.com/stripe/stripe-go/v86/filelink"
	financialconnectionsaccount "github.com/stripe/stripe-go/v86/financialconnections/account"
	financialconnectionsaccountinferredbalance "github.com/stripe/stripe-go/v86/financialconnections/accountinferredbalance"
	financialconnectionsauthorization "github.com/stripe/stripe-go/v86/financialconnections/authorization"
	financialconnectionsconsent "github.com/stripe/stripe-go/v86/financialconnections/consent"
	financialconnectionsinstitution "github.com/stripe/stripe-go/v86/financialconnections/institution"
	financialconnectionssession "github.com/stripe/stripe-go/v86/financialconnections/session"
	financialconnectionstransaction "github.com/stripe/stripe-go/v86/financialconnections/transaction"
	forwardingrequest "github.com/stripe/stripe-go/v86/forwarding/request"
	"github.com/stripe/stripe-go/v86/fxquote"
	"github.com/stripe/stripe-go/v86/giftcard"
	"github.com/stripe/stripe-go/v86/giftcardoperation"
	identityblocklistentry "github.com/stripe/stripe-go/v86/identity/blocklistentry"
	identityverificationreport "github.com/stripe/stripe-go/v86/identity/verificationreport"
	identityverificationsession "github.com/stripe/stripe-go/v86/identity/verificationsession"
	"github.com/stripe/stripe-go/v86/invoice"
	"github.com/stripe/stripe-go/v86/invoiceitem"
	"github.com/stripe/stripe-go/v86/invoicelineitem"
	"github.com/stripe/stripe-go/v86/invoicepayment"
	"github.com/stripe/stripe-go/v86/invoicerenderingtemplate"
	issuingauthorization "github.com/stripe/stripe-go/v86/issuing/authorization"
	issuingcard "github.com/stripe/stripe-go/v86/issuing/card"
	issuingcardholder "github.com/stripe/stripe-go/v86/issuing/cardholder"
	issuingcreditunderwritingrecord "github.com/stripe/stripe-go/v86/issuing/creditunderwritingrecord"
	issuingdispute "github.com/stripe/stripe-go/v86/issuing/dispute"
	issuingdisputesettlementdetail "github.com/stripe/stripe-go/v86/issuing/disputesettlementdetail"
	issuingfraudliabilitydebit "github.com/stripe/stripe-go/v86/issuing/fraudliabilitydebit"
	issuingpersonalizationdesign "github.com/stripe/stripe-go/v86/issuing/personalizationdesign"
	issuingphysicalbundle "github.com/stripe/stripe-go/v86/issuing/physicalbundle"
	issuingprogram "github.com/stripe/stripe-go/v86/issuing/program"
	issuingtoken "github.com/stripe/stripe-go/v86/issuing/token"
	issuingtransaction "github.com/stripe/stripe-go/v86/issuing/transaction"
	"github.com/stripe/stripe-go/v86/loginlink"
	"github.com/stripe/stripe-go/v86/mandate"
	"github.com/stripe/stripe-go/v86/margin"
	"github.com/stripe/stripe-go/v86/oauth"
	orchestrationpaymentattempt "github.com/stripe/stripe-go/v86/orchestration/paymentattempt"
	"github.com/stripe/stripe-go/v86/order"
	"github.com/stripe/stripe-go/v86/paymentattemptrecord"
	"github.com/stripe/stripe-go/v86/paymentintent"
	"github.com/stripe/stripe-go/v86/paymentintentamountdetailslineitem"
	"github.com/stripe/stripe-go/v86/paymentlink"
	"github.com/stripe/stripe-go/v86/paymentlocation"
	"github.com/stripe/stripe-go/v86/paymentlocationcapability"
	"github.com/stripe/stripe-go/v86/paymentmethod"
	"github.com/stripe/stripe-go/v86/paymentmethodconfiguration"
	"github.com/stripe/stripe-go/v86/paymentmethoddomain"
	"github.com/stripe/stripe-go/v86/paymentplan"
	"github.com/stripe/stripe-go/v86/paymentrecord"
	"github.com/stripe/stripe-go/v86/paymentsource"
	"github.com/stripe/stripe-go/v86/payout"
	"github.com/stripe/stripe-go/v86/person"
	"github.com/stripe/stripe-go/v86/plan"
	"github.com/stripe/stripe-go/v86/price"
	privacyredactionjob "github.com/stripe/stripe-go/v86/privacy/redactionjob"
	privacyredactionjobvalidationerror "github.com/stripe/stripe-go/v86/privacy/redactionjobvalidationerror"
	...
	radarvaluelistitem "github.com/stripe/stripe-go/v86/radar/valuelistitem"
	"github.com/stripe/stripe-go/v86/refund"
	reportingreportrun "github.com/stripe/stripe-go/v86/reporting/reportrun"
	reportingreporttype "github.com/stripe/stripe-go/v86/reporting/reporttype"
	reservehold "github.com/stripe/stripe-go/v86/reserve/hold"
	reserveplan "github.com/stripe/stripe-go/v86/reserve/plan"
	reserverelease "github.com/stripe/stripe-go/v86/reserve/release"
	"github.com/stripe/stripe-go/v86/review"
	"github.com/stripe/stripe-go/v86/setupattempt"
	"github.com/stripe/stripe-go/v86/setupintent"
	sharedpaymentgrantedtoken "github.com/stripe/stripe-go/v86/sharedpayment/grantedtoken"
	sharedpaymentissuedtoken "github.com/stripe/stripe-go/v86/sharedpayment/issuedtoken"
	"github.com/stripe/stripe-go/v86/shippingrate"
	sigmascheduledqueryrun "github.com/stripe/stripe-go/v86/sigma/scheduledqueryrun"
	"github.com/stripe/stripe-go/v86/source"
	"github.com/stripe/stripe-go/v86/sourcetransaction"
	...
	taxform "github.com/stripe/stripe-go/v86/tax/form"
	...
	"github.com/stripe/stripe-go/v86/taxcode"
	"github.com/stripe/stripe-go/v86/taxfund"
	"github.com/stripe/stripe-go/v86/taxid"
	"github.com/stripe/stripe-go/v86/taxrate"
	terminalconfiguration "github.com/stripe/stripe-go/v86/terminal/configuration"
	terminalconnectiontoken "github.com/stripe/stripe-go/v86/terminal/connectiontoken"
	terminallocation "github.com/stripe/stripe-go/v86/terminal/location"
	terminalonboardinglink "github.com/stripe/stripe-go/v86/terminal/onboardinglink"
	terminalreader "github.com/stripe/stripe-go/v86/terminal/reader"
	terminalreadercollecteddata "github.com/stripe/stripe-go/v86/terminal/readercollecteddata"
	testhelperscapitalfinancingoffer "github.com/stripe/stripe-go/v86/testhelpers/capital/financingoffer"
	testhelpersconfirmationtoken "github.com/stripe/stripe-go/v86/testhelpers/confirmationtoken"
	testhelperscustomer "github.com/stripe/stripe-go/v86/testhelpers/customer"
	testhelpersissuingauthorization "github.com/stripe/stripe-go/v86/testhelpers/issuing/authorization"
	testhelpersissuingcard "github.com/stripe/stripe-go/v86/testhelpers/issuing/card"
	testhelpersissuingdispute "github.com/stripe/stripe-go/v86/testhelpers/issuing/dispute"
	testhelpersissuingpersonalizationdesign "github.com/stripe/stripe-go/v86/testhelpers/issuing/personalizationdesign"
	testhelpersissuingtransaction "github.com/stripe/stripe-go/v86/testhelpers/issuing/transaction"
	testhelperspaymentintent "github.com/stripe/stripe-go/v86/testhelpers/paymentintent"
	testhelpersrefund "github.com/stripe/stripe-go/v86/testhelpers/refund"
	testhelperssharedpaymentgrantedtoken "github.com/stripe/stripe-go/v86/testhelpers/sharedpayment/grantedtoken"
	testhelpersterminalreader "github.com/stripe/stripe-go/v86/testhelpers/terminal/reader"
	testhelperstestclock "github.com/stripe/stripe-go/v86/testhelpers/testclock"
	testhelperstreasuryinboundtransfer "github.com/stripe/stripe-go/v86/testhelpers/treasury/inboundtransfer"
	testhelperstreasuryoutboundpayment "github.com/stripe/stripe-go/v86/testhelpers/treasury/outboundpayment"
	...
	"github.com/stripe/stripe-go/v86/transferreversal"
	treasurycreditreversal "github.com/stripe/stripe-go/v86/treasury/creditreversal"
	treasurydebitreversal "github.com/stripe/stripe-go/v86/treasury/debitreversal"
	treasuryfinancialaccount "github.com/stripe/stripe-go/v86/treasury/financialaccount"
	treasuryinboundtransfer "github.com/stripe/stripe-go/v86/treasury/inboundtransfer"
	treasuryoutboundpayment "github.com/stripe/stripe-go/v86/treasury/outboundpayment"
	treasuryoutboundtransfer "github.com/stripe/stripe-go/v86/treasury/outboundtransfer"
	treasuryreceivedcredit "github.com/stripe/stripe-go/v86/treasury/receivedcredit"
	treasuryreceiveddebit "github.com/stripe/stripe-go/v86/treasury/receiveddebit"
	treasurytransaction "github.com/stripe/stripe-go/v86/treasury/transaction"
	treasurytransactionentry "github.com/stripe/stripe-go/v86/treasury/transactionentry"
	v2billingbillsetting "github.com/stripe/stripe-go/v86/v2/billing/billsetting"
	v2billingbillsettingsversion "github.com/stripe/stripe-go/v86/v2/billing/billsettings/version"
	v2billingcadence "github.com/stripe/stripe-go/v86/v2/billing/cadence"
	v2billingcadencesspendmodifierrule "github.com/stripe/stripe-go/v86/v2/billing/cadences/spendmodifierrule"
	v2billingcollectionsetting "github.com/stripe/stripe-go/v86/v2/billing/collectionsetting"
	v2billingcollectionsettingsversion "github.com/stripe/stripe-go/v86/v2/billing/collectionsettings/version"
	v2billingcontract "github.com/stripe/stripe-go/v86/v2/billing/contract"
	v2billingcontractspricinglinesquantitychange "github.com/stripe/stripe-go/v86/v2/billing/contracts/pricinglines/quantitychange"
	v2billingcustompricingunit "github.com/stripe/stripe-go/v86/v2/billing/custompricingunit"
	v2billingintent "github.com/stripe/stripe-go/v86/v2/billing/intent"
	v2billingintentsaction "github.com/stripe/stripe-go/v86/v2/billing/intents/action"
	v2billinglicenseditem "github.com/stripe/stripe-go/v86/v2/billing/licenseditem"
	v2billinglicensefee "github.com/stripe/stripe-go/v86/v2/billing/licensefee"
	v2billinglicensefeesversion "github.com/stripe/stripe-go/v86/v2/billing/licensefees/version"
	v2billingmetereditem "github.com/stripe/stripe-go/v86/v2/billing/metereditem"
	v2billingmeterevent "github.com/stripe/stripe-go/v86/v2/billing/meterevent"
	v2billingmetereventadjustment "github.com/stripe/stripe-go/v86/v2/billing/metereventadjustment"
	v2billingmetereventsession "github.com/stripe/stripe-go/v86/v2/billing/metereventsession"
	v2billingmetereventstream "github.com/stripe/stripe-go/v86/v2/billing/metereventstream"
	v2billingonetimeitem "github.com/stripe/stripe-go/v86/v2/billing/onetimeitem"
	v2billingpricingplan "github.com/stripe/stripe-go/v86/v2/billing/pricingplan"
	v2billingpricingplanscomponent "github.com/stripe/stripe-go/v86/v2/billing/pricingplans/component"
	v2billingpricingplansversion "github.com/stripe/stripe-go/v86/v2/billing/pricingplans/version"
	v2billingpricingplansubscription "github.com/stripe/stripe-go/v86/v2/billing/pricingplansubscription"
	v2billingprofile "github.com/stripe/stripe-go/v86/v2/billing/profile"
	v2billingratecard "github.com/stripe/stripe-go/v86/v2/billing/ratecard"
	v2billingratecardscustompricingunitoveragerate "github.com/stripe/stripe-go/v86/v2/billing/ratecards/custompricingunitoveragerate"
	v2billingratecardsrate "github.com/stripe/stripe-go/v86/v2/billing/ratecards/rate"
	v2billingratecardsversion "github.com/stripe/stripe-go/v86/v2/billing/ratecards/version"
	v2billingratecardsubscription "github.com/stripe/stripe-go/v86/v2/billing/ratecardsubscription"
	v2billingserviceaction "github.com/stripe/stripe-go/v86/v2/billing/serviceaction"
	v2coreaccount "github.com/stripe/stripe-go/v86/v2/core/account"
	v2coreaccountevaluation "github.com/stripe/stripe-go/v86/v2/core/accountevaluation"
	v2coreaccountlink "github.com/stripe/stripe-go/v86/v2/core/accountlink"
	...
	v2coreclaimablesandbox "github.com/stripe/stripe-go/v86/v2/core/claimablesandbox"
	v2coreconnectionsession "github.com/stripe/stripe-go/v86/v2/core/connectionsession"
	...
	v2iamapikey "github.com/stripe/stripe-go/v86/v2/iam/apikey"
...
type API struct {
	...
	// FinancialConnectionsConsents is the client used to invoke /v1/financial_connections/consents APIs.
	FinancialConnectionsConsents *financialconnectionsconsent.Client
	...
	// PaymentPlans is the client used to invoke /v1/payment_plans APIs.
	...
	// V2BillingContractsPricingLinesQuantityChanges is the client used to invoke quantitychange related APIs.
	V2BillingContractsPricingLinesQuantityChanges *v2billingcontractspricinglinesquantitychange.Client
...
func (a *API) Init(key string, backends *stripe.Backends) {
	...
	a.FinancialConnectionsConsents = &financialconnectionsconsent.Client{B: backends.API, Key: key}
	...
	a.PaymentPlans = &paymentplan.Client{B: backends.API, Key: key}
	...
	a.V2BillingContractsPricingLinesQuantityChanges = &v2billingcontractspricinglinesquantitychange.Client{B: backends.API, Key: key}
