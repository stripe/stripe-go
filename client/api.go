...
func (a *Api) Init(tok string, client *http.Client, backend Backend) {
	...
	a.Charges = &charge.Client{B: a.backend, Token: a.token}
	a.Customers = &customer.Client{B: a.backend, Token: a.token}
	a.Cards = &card.Client{B: a.backend, Token: a.token}
	a.Subs = &sub.Client{B: a.backend, Token: a.token}
	a.Plans = &plan.Client{B: a.backend, Token: a.token}
	a.Coupons = &coupon.Client{B: a.backend, Token: a.token}
	a.Discounts = &discount.Client{B: a.backend, Token: a.token}
	a.Invoices = &invoice.Client{B: a.backend, Token: a.token}
	a.InvoiceItems = &invoiceitem.Client{B: a.backend, Token: a.token}
	a.Disputes = &dispute.Client{B: a.backend, Token: a.token}
	a.Transfers = &transfer.Client{B: a.backend, Token: a.token}
	a.Recipients = &recipient.Client{B: a.backend, Token: a.token}
	a.Refunds = &refund.Client{B: a.backend, Token: a.token}
	a.Fees = &fee.Client{B: a.backend, Token: a.token}
	a.FeeRefunds = &feerefund.Client{B: a.backend, Token: a.token}
	a.Account = &account.Client{B: a.backend, Token: a.token}
	a.Balance = &balance.Client{B: a.backend, Token: a.token}
	a.Events = &event.Client{B: a.backend, Token: a.token}
	a.Tokens = &token.Client{B: a.backend, Token: a.token}
}
