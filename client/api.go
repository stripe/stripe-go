...
import (
	...
	"github.com/stripe/stripe-go/v80/accountnotice"
	"github.com/stripe/stripe-go/v80/accountsession"
	"github.com/stripe/stripe-go/v80/applepaydomain"
	"github.com/stripe/stripe-go/v80/applicationfee"
	appssecret "github.com/stripe/stripe-go/v80/apps/secret"
	...
	billingalert "github.com/stripe/stripe-go/v80/billing/alert"
	billingcreditbalancesummary "github.com/stripe/stripe-go/v80/billing/creditbalancesummary"
	billingcreditbalancetransaction "github.com/stripe/stripe-go/v80/billing/creditbalancetransaction"
	billingcreditgrant "github.com/stripe/stripe-go/v80/billing/creditgrant"
	billingmeter "github.com/stripe/stripe-go/v80/billing/meter"
	billingmeterevent "github.com/stripe/stripe-go/v80/billing/meterevent"
	billingmetereventadjustment "github.com/stripe/stripe-go/v80/billing/metereventadjustment"
	billingmetereventsummary "github.com/stripe/stripe-go/v80/billing/metereventsummary"
	billingportalconfiguration "github.com/stripe/stripe-go/v80/billingportal/configuration"
	billingportalsession "github.com/stripe/stripe-go/v80/billingportal/session"
	"github.com/stripe/stripe-go/v80/capability"
	capitalfinancingoffer "github.com/stripe/stripe-go/v80/capital/financingoffer"
	capitalfinancingsummary "github.com/stripe/stripe-go/v80/capital/financingsummary"
	capitalfinancingtransaction "github.com/stripe/stripe-go/v80/capital/financingtransaction"
	"github.com/stripe/stripe-go/v80/card"
	"github.com/stripe/stripe-go/v80/cashbalance"
	"github.com/stripe/stripe-go/v80/charge"
	checkoutsession "github.com/stripe/stripe-go/v80/checkout/session"
	climateorder "github.com/stripe/stripe-go/v80/climate/order"
	climateproduct "github.com/stripe/stripe-go/v80/climate/product"
	climatesupplier "github.com/stripe/stripe-go/v80/climate/supplier"
	"github.com/stripe/stripe-go/v80/confirmationtoken"
	"github.com/stripe/stripe-go/v80/countryspec"
	"github.com/stripe/stripe-go/v80/coupon"
	"github.com/stripe/stripe-go/v80/creditnote"
	"github.com/stripe/stripe-go/v80/customer"
	"github.com/stripe/stripe-go/v80/customerbalancetransaction"
	"github.com/stripe/stripe-go/v80/customercashbalancetransaction"
	"github.com/stripe/stripe-go/v80/customersession"
	"github.com/stripe/stripe-go/v80/dispute"
	entitlementsactiveentitlement "github.com/stripe/stripe-go/v80/entitlements/activeentitlement"
	entitlementsfeature "github.com/stripe/stripe-go/v80/entitlements/feature"
	"github.com/stripe/stripe-go/v80/ephemeralkey"
	"github.com/stripe/stripe-go/v80/event"
	"github.com/stripe/stripe-go/v80/feerefund"
	"github.com/stripe/stripe-go/v80/file"
	"github.com/stripe/stripe-go/v80/filelink"
	financialconnectionsaccount "github.com/stripe/stripe-go/v80/financialconnections/account"
	financialconnectionsaccountinferredbalance "github.com/stripe/stripe-go/v80/financialconnections/accountinferredbalance"
	financialconnectionsinstitution "github.com/stripe/stripe-go/v80/financialconnections/institution"
	financialconnectionssession "github.com/stripe/stripe-go/v80/financialconnections/session"
	financialconnectionstransaction "github.com/stripe/stripe-go/v80/financialconnections/transaction"
	forwardingrequest "github.com/stripe/stripe-go/v80/forwarding/request"
	giftcardscard "github.com/stripe/stripe-go/v80/giftcards/card"
	giftcardstransaction "github.com/stripe/stripe-go/v80/giftcards/transaction"
	identityverificationreport "github.com/stripe/stripe-go/v80/identity/verificationreport"
	identityverificationsession "github.com/stripe/stripe-go/v80/identity/verificationsession"
	"github.com/stripe/stripe-go/v80/invoice"
	"github.com/stripe/stripe-go/v80/invoiceitem"
	"github.com/stripe/stripe-go/v80/invoicelineitem"
	"github.com/stripe/stripe-go/v80/invoicepayment"
	"github.com/stripe/stripe-go/v80/invoicerenderingtemplate"
	issuingauthorization "github.com/stripe/stripe-go/v80/issuing/authorization"
	issuingcard "github.com/stripe/stripe-go/v80/issuing/card"
	issuingcardholder "github.com/stripe/stripe-go/v80/issuing/cardholder"
	issuingcreditunderwritingrecord "github.com/stripe/stripe-go/v80/issuing/creditunderwritingrecord"
	issuingdispute "github.com/stripe/stripe-go/v80/issuing/dispute"
	issuingdisputesettlementdetail "github.com/stripe/stripe-go/v80/issuing/disputesettlementdetail"
	issuingpersonalizationdesign "github.com/stripe/stripe-go/v80/issuing/personalizationdesign"
	issuingphysicalbundle "github.com/stripe/stripe-go/v80/issuing/physicalbundle"
	issuingtoken "github.com/stripe/stripe-go/v80/issuing/token"
	issuingtransaction "github.com/stripe/stripe-go/v80/issuing/transaction"
	"github.com/stripe/stripe-go/v80/loginlink"
	"github.com/stripe/stripe-go/v80/mandate"
	"github.com/stripe/stripe-go/v80/margin"
	"github.com/stripe/stripe-go/v80/oauth"
	"github.com/stripe/stripe-go/v80/order"
	"github.com/stripe/stripe-go/v80/paymentintent"
	"github.com/stripe/stripe-go/v80/paymentlink"
	"github.com/stripe/stripe-go/v80/paymentmethod"
	"github.com/stripe/stripe-go/v80/paymentmethodconfiguration"
	"github.com/stripe/stripe-go/v80/paymentmethoddomain"
	"github.com/stripe/stripe-go/v80/paymentsource"
	"github.com/stripe/stripe-go/v80/payout"
	"github.com/stripe/stripe-go/v80/person"
	"github.com/stripe/stripe-go/v80/plan"
	"github.com/stripe/stripe-go/v80/price"
	"github.com/stripe/stripe-go/v80/product"
	"github.com/stripe/stripe-go/v80/productfeature"
	"github.com/stripe/stripe-go/v80/promotioncode"
	"github.com/stripe/stripe-go/v80/quote"
	"github.com/stripe/stripe-go/v80/quotepreviewinvoice"
	"github.com/stripe/stripe-go/v80/quotepreviewsubscriptionschedule"
	radarearlyfraudwarning "github.com/stripe/stripe-go/v80/radar/earlyfraudwarning"
	radarvaluelist "github.com/stripe/stripe-go/v80/radar/valuelist"
	radarvaluelistitem "github.com/stripe/stripe-go/v80/radar/valuelistitem"
	"github.com/stripe/stripe-go/v80/refund"
	reportingreportrun "github.com/stripe/stripe-go/v80/reporting/reportrun"
	reportingreporttype "github.com/stripe/stripe-go/v80/reporting/reporttype"
	"github.com/stripe/stripe-go/v80/review"
	"github.com/stripe/stripe-go/v80/setupattempt"
	"github.com/stripe/stripe-go/v80/setupintent"
	"github.com/stripe/stripe-go/v80/shippingrate"
	sigmascheduledqueryrun "github.com/stripe/stripe-go/v80/sigma/scheduledqueryrun"
	"github.com/stripe/stripe-go/v80/source"
	"github.com/stripe/stripe-go/v80/sourcetransaction"
	...
	taxassociation "github.com/stripe/stripe-go/v80/tax/association"
	taxcalculation "github.com/stripe/stripe-go/v80/tax/calculation"
	taxform "github.com/stripe/stripe-go/v80/tax/form"
	taxregistration "github.com/stripe/stripe-go/v80/tax/registration"
	taxsettings "github.com/stripe/stripe-go/v80/tax/settings"
	taxtransaction "github.com/stripe/stripe-go/v80/tax/transaction"
	"github.com/stripe/stripe-go/v80/taxcode"
	"github.com/stripe/stripe-go/v80/taxid"
	"github.com/stripe/stripe-go/v80/taxrate"
	terminalconfiguration "github.com/stripe/stripe-go/v80/terminal/configuration"
	terminalconnectiontoken "github.com/stripe/stripe-go/v80/terminal/connectiontoken"
	terminallocation "github.com/stripe/stripe-go/v80/terminal/location"
	terminalreader "github.com/stripe/stripe-go/v80/terminal/reader"
	...
	testhelpersissuingtransaction "github.com/stripe/stripe-go/v80/testhelpers/issuing/transaction"
	testhelpersrefund "github.com/stripe/stripe-go/v80/testhelpers/refund"
	testhelpersterminalreader "github.com/stripe/stripe-go/v80/testhelpers/terminal/reader"
	testhelperstestclock "github.com/stripe/stripe-go/v80/testhelpers/testclock"
	testhelperstreasuryinboundtransfer "github.com/stripe/stripe-go/v80/testhelpers/treasury/inboundtransfer"
	testhelperstreasuryoutboundpayment "github.com/stripe/stripe-go/v80/testhelpers/treasury/outboundpayment"
	testhelperstreasuryoutboundtransfer "github.com/stripe/stripe-go/v80/testhelpers/treasury/outboundtransfer"
	testhelperstreasuryreceivedcredit "github.com/stripe/stripe-go/v80/testhelpers/treasury/receivedcredit"
	testhelperstreasuryreceiveddebit "github.com/stripe/stripe-go/v80/testhelpers/treasury/receiveddebit"
	"github.com/stripe/stripe-go/v80/token"
	"github.com/stripe/stripe-go/v80/topup"
	"github.com/stripe/stripe-go/v80/transfer"
	"github.com/stripe/stripe-go/v80/transferreversal"
	treasurycreditreversal "github.com/stripe/stripe-go/v80/treasury/creditreversal"
	treasurydebitreversal "github.com/stripe/stripe-go/v80/treasury/debitreversal"
	treasuryfinancialaccount "github.com/stripe/stripe-go/v80/treasury/financialaccount"
	treasuryinboundtransfer "github.com/stripe/stripe-go/v80/treasury/inboundtransfer"
	treasuryoutboundpayment "github.com/stripe/stripe-go/v80/treasury/outboundpayment"
	treasuryoutboundtransfer "github.com/stripe/stripe-go/v80/treasury/outboundtransfer"
	treasuryreceivedcredit "github.com/stripe/stripe-go/v80/treasury/receivedcredit"
	treasuryreceiveddebit "github.com/stripe/stripe-go/v80/treasury/receiveddebit"
	treasurytransaction "github.com/stripe/stripe-go/v80/treasury/transaction"
	treasurytransactionentry "github.com/stripe/stripe-go/v80/treasury/transactionentry"
	"github.com/stripe/stripe-go/v80/usagerecord"
	"github.com/stripe/stripe-go/v80/usagerecordsummary"
...
type API struct {
	...
	// Margins is the client used to invoke /billing/margins APIs.
	...
	// TerminalReaderCollectedData is the client used to invoke /terminal/reader_collected_data APIs.
