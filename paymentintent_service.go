...
// Returns a list of PaymentIntents.
func (c v1PaymentIntentService) ListWithPage(ctx context.Context, listParams *PaymentIntentListParams) *V1List[*PaymentIntent] {
	if listParams == nil {
...
// conditions, data is searchable in less than a minute. Occasionally, propagation of new or updated data can be up
// to an hour behind during outages. Search functionality is not available to merchants in India.
func (c v1PaymentIntentService) SearchWithPage(ctx context.Context, params *PaymentIntentSearchParams) *V1SearchList[*PaymentIntent] {
	if params == nil {
