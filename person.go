...
type PersonParams struct {
	...
	SelfReportedIncome *PersonSelfReportedIncomeParams `form:"self_reported_income" json:"self_reported_income,omitempty"`
...
type PersonUpdateParams struct {
	...
	// The credit applicant's self-reported yearly income in minor units.
	SelfReportedIncome *PersonUpdateSelfReportedIncomeParams `form:"self_reported_income" json:"self_reported_income,omitempty"`
	// The credit applicant's self-reported monthly housing payment in minor units.
...
type PersonCreateParams struct {
	...
	// The credit applicant's self-reported yearly income in minor units.
	SelfReportedIncome *PersonCreateSelfReportedIncomeParams `form:"self_reported_income" json:"self_reported_income,omitempty"`
	// The credit applicant's self-reported monthly housing payment in minor units.
...
type Person struct {
	...
	SelfReportedIncome                *PersonSelfReportedIncome                `json:"self_reported_income,omitempty"`
	SelfReportedMonthlyHousingPayment *PersonSelfReportedMonthlyHousingPayment `json:"self_reported_monthly_housing_payment,omitempty"`
