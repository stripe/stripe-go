...
type FinancialConnectionsInferredBalance struct {
...
// FinancialConnectionsInferredBalanceList is a list of InferredBalances as retrieved from a list endpoint.
type FinancialConnectionsInferredBalanceList struct {
	APIResource
	ListMeta
	Data []*FinancialConnectionsInferredBalance `json:"data"`
}
