...
const (
	...
	V2CoreBatchJobsPathCashBalanceUpdate                 V2CoreBatchJobsPath = "/v1/customers/:id/cash_balance"
	V2CoreBatchJobsPathCustomerBalanceTransactionCreate  V2CoreBatchJobsPath = "/v1/customers/:id/balance_transactions"
	V2CoreBatchJobsPathCustomerBalanceTransactionUpdate  V2CoreBatchJobsPath = "/v1/customers/:customer_id/balance_transactions/:id"
	V2CoreBatchJobsPathPaymentSourceCreate               V2CoreBatchJobsPath = "/v1/customers/:id/sources"
	V2CoreBatchJobsPathBankAccountUpdate                 V2CoreBatchJobsPath = "/v1/customers/:customer_id/sources/:id"
	V2CoreBatchJobsPathBankAccountDelete                 V2CoreBatchJobsPath = "/v1/customers/:customer_id/sources/:id"
	V2CoreBatchJobsPathTaxIDCreateForCustomer            V2CoreBatchJobsPath = "/v1/customers/:id/tax_ids"
	V2CoreBatchJobsPathTaxIDDelete                       V2CoreBatchJobsPath = "/v1/customers/:customer_id/tax_ids/:id"
	...
	V2CoreBatchJobsPathProductFeatureDelete              V2CoreBatchJobsPath = "/v1/products/:product_id/features/:id"
	V2CoreBatchJobsPathProductFeatureCreate              V2CoreBatchJobsPath = "/v1/products/:id/features"
