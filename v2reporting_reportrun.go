...
type V2ReportingReportRunReportParametersArrayValue struct {
	// The list of string values in the array.
	Items []string `json:"items"`
}

// The parameters used to customize the generation of the report.
type V2ReportingReportRunReportParameters struct {
	// Parameter with an array data type.
	ArrayValue *V2ReportingReportRunReportParametersArrayValue `json:"array_value"`
...
type V2ReportingReportRunStatusDetails struct {
	// Error code categorizing the reason the `ReportRun` failed.
	ErrorCode V2ReportingReportRunStatusDetailsErrorCode `json:"error_code"`
...
type V2ReportingReportRun struct {
	...
	// The parameters used to customize the generation of the report.
	ReportParameters map[string]*V2ReportingReportRunReportParameters `json:"report_parameters"`
	// Details how to retrieve the results of a successfully completed `ReportRun`.
	Result *V2ReportingReportRunResult `json:"result"`
	// The options specified for customizing the output file of the `ReportRun`.
	ResultOptions *V2ReportingReportRunResultOptions `json:"result_options"`
	// The current status of the `ReportRun`.
