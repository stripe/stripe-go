...
// List payment method configurations
func (c v1PaymentMethodConfigurationService) ListWithPage(ctx context.Context, listParams *PaymentMethodConfigurationListParams) *V1List[*PaymentMethodConfiguration] {
	if listParams == nil {
