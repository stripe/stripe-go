...
func (c v2BillingBillSettingsVersionService) List(ctx context.Context, listParams *V2BillingBillSettingsVersionListParams) *V2List[*V2BillingBillSettingVersion] {
	if listParams == nil {
	...
	return newV2List(ctx, path, listParams, func(ctx context.Context, path string, p ParamsContainer) (*V2Page[*V2BillingBillSettingVersion], error) {
		if p.GetParams() != nil {
