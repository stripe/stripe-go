...
const (
	...
	QuoteStatusDetailsStaleLastReasonTypeBillingSchedulesInvalid      QuoteStatusDetailsStaleLastReasonType = "billing_schedules_invalid"
...
type QuoteInvoiceSettingsCustomFieldParams struct {
...
type QuoteInvoiceSettingsParams struct {
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*QuoteInvoiceSettingsCustomFieldParams `form:"custom_fields" json:"custom_fields,omitempty"`
	...
	UnsetFields []QuoteInvoiceSettingsParamsUnsetField `form:"-" json:"-"`
}

// QuoteInvoiceSettingsParamsUnsetField is the list of fields that can be cleared/unset on QuoteInvoiceSettingsParams.
type QuoteInvoiceSettingsParamsUnsetField string

const (
	QuoteInvoiceSettingsParamsUnsetFieldCustomFields QuoteInvoiceSettingsParamsUnsetField = "custom_fields"
	QuoteInvoiceSettingsParamsUnsetFieldDescription  QuoteInvoiceSettingsParamsUnsetField = "description"
	QuoteInvoiceSettingsParamsUnsetFieldFooter       QuoteInvoiceSettingsParamsUnsetField = "footer"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *QuoteInvoiceSettingsParams) AddUnsetField(field QuoteInvoiceSettingsParamsUnsetField) {
...
const (
	...
	QuoteSubscriptionDataParamsUnsetFieldBillingSchedules   QuoteSubscriptionDataParamsUnsetField = "billing_schedules"
...
type QuoteListPreviewInvoiceLinesParams struct {
	ListParams `form:"*"`
	ID         *string `form:"-"` // Included in URL
	QuoteID    *string `form:"-"` // Included in URL
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
}
...
// A list of up to 4 custom fields to be displayed on the invoice.
type QuoteCreateInvoiceSettingsCustomFieldParams struct {
	// The name of the custom field. This may be up to 40 characters.
	Name *string `form:"name" json:"name"`
	// The value of the custom field. This may be up to 140 characters.
	Value *string `form:"value" json:"value"`
...
type QuoteCreateInvoiceSettingsParams struct {
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*QuoteCreateInvoiceSettingsCustomFieldParams `form:"custom_fields" json:"custom_fields,omitempty"`
	// Number of days within which a customer must pay the invoice generated by this quote. This value will be `null` for quotes where `collection_method=charge_automatically`.
	DaysUntilDue *int64 `form:"days_until_due" json:"days_until_due,omitempty"`
	// An arbitrary string attached to the object. Often useful for displaying to users.
	Description *string `form:"description" json:"description,omitempty"`
	...
	UnsetFields []QuoteCreateInvoiceSettingsParamsUnsetField `form:"-" json:"-"`
}

// QuoteCreateInvoiceSettingsParamsUnsetField is the list of fields that can be cleared/unset on QuoteCreateInvoiceSettingsParams.
type QuoteCreateInvoiceSettingsParamsUnsetField string

const (
	QuoteCreateInvoiceSettingsParamsUnsetFieldCustomFields QuoteCreateInvoiceSettingsParamsUnsetField = "custom_fields"
	QuoteCreateInvoiceSettingsParamsUnsetFieldDescription  QuoteCreateInvoiceSettingsParamsUnsetField = "description"
	QuoteCreateInvoiceSettingsParamsUnsetFieldFooter       QuoteCreateInvoiceSettingsParamsUnsetField = "footer"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *QuoteCreateInvoiceSettingsParams) AddUnsetField(field QuoteCreateInvoiceSettingsParamsUnsetField) {
	p.UnsetFields = append(p.UnsetFields, field)
}
...
// A list of up to 4 custom fields to be displayed on the invoice.
type QuoteUpdateInvoiceSettingsCustomFieldParams struct {
	// The name of the custom field. This may be up to 40 characters.
	Name *string `form:"name" json:"name"`
	// The value of the custom field. This may be up to 140 characters.
	Value *string `form:"value" json:"value"`
...
type QuoteUpdateInvoiceSettingsParams struct {
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*QuoteUpdateInvoiceSettingsCustomFieldParams `form:"custom_fields" json:"custom_fields,omitempty"`
	// Number of days within which a customer must pay the invoice generated by this quote. This value will be `null` for quotes where `collection_method=charge_automatically`.
	DaysUntilDue *int64 `form:"days_until_due" json:"days_until_due,omitempty"`
	// An arbitrary string attached to the object. Often useful for displaying to users.
	Description *string `form:"description" json:"description,omitempty"`
	...
	UnsetFields []QuoteUpdateInvoiceSettingsParamsUnsetField `form:"-" json:"-"`
}

// QuoteUpdateInvoiceSettingsParamsUnsetField is the list of fields that can be cleared/unset on QuoteUpdateInvoiceSettingsParams.
type QuoteUpdateInvoiceSettingsParamsUnsetField string

const (
	QuoteUpdateInvoiceSettingsParamsUnsetFieldCustomFields QuoteUpdateInvoiceSettingsParamsUnsetField = "custom_fields"
	QuoteUpdateInvoiceSettingsParamsUnsetFieldDescription  QuoteUpdateInvoiceSettingsParamsUnsetField = "description"
	QuoteUpdateInvoiceSettingsParamsUnsetFieldFooter       QuoteUpdateInvoiceSettingsParamsUnsetField = "footer"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *QuoteUpdateInvoiceSettingsParams) AddUnsetField(field QuoteUpdateInvoiceSettingsParamsUnsetField) {
	p.UnsetFields = append(p.UnsetFields, field)
}
...
const (
	...
	QuoteUpdateSubscriptionDataParamsUnsetFieldBillingSchedules   QuoteUpdateSubscriptionDataParamsUnsetField = "billing_schedules"
...
// A list of up to 4 custom fields to be displayed on the invoice.
type QuoteInvoiceSettingsCustomField struct {
...
type QuoteInvoiceSettings struct {
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*QuoteInvoiceSettingsCustomField `json:"custom_fields"`
...
// Specifies which subscription items the billing schedule applies to.
type QuoteSubscriptionDataOverrideBillingScheduleAppliesTo struct {
	// The billing schedule will apply to the subscription item with the given price ID.
	Price *Price `json:"price"`
	// Controls which subscription items the billing schedule applies to.
