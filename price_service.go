...
func (c v1PriceService) MarshalBatchCreate(params *PriceCreateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1PriceService) MarshalBatchUpdate(id string, params *PriceUpdateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
