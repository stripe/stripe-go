...
// Returns a list of Checkout Sessions.
func (c v1CheckoutSessionService) ListWithPage(ctx context.Context, listParams *CheckoutSessionListParams) *V1List[*CheckoutSession] {
	if listParams == nil {
...
// When retrieving a Checkout Session, there is an includable line_items property containing the first handful of those items. There is also a URL where you can retrieve the full (paginated) list of line items.
func (c v1CheckoutSessionService) ListLineItemsWithPage(ctx context.Context, listParams *CheckoutSessionListLineItemsParams) *V1List[*LineItem] {
	if listParams == nil {
