...
type PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticaptureStatus string

// List of values that PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticaptureStatus can take
const (
	PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticaptureStatusAvailable   PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticaptureStatus = "available"
	PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticaptureStatusUnavailable PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticaptureStatus = "unavailable"
)
...
type PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorizationStatus string

// List of values that PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorizationStatus can take
const (
	PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorizationStatusAvailable   PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorizationStatus = "available"
	PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorizationStatusUnavailable PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorizationStatus = "unavailable"
)
...
type PaymentAttemptRecordPaymentMethodDetailsGiftCardBrand string

// List of values that PaymentAttemptRecordPaymentMethodDetailsGiftCardBrand can take
const (
	PaymentAttemptRecordPaymentMethodDetailsGiftCardBrandFiservValuelink PaymentAttemptRecordPaymentMethodDetailsGiftCardBrand = "fiserv_valuelink"
	PaymentAttemptRecordPaymentMethodDetailsGiftCardBrandGivex           PaymentAttemptRecordPaymentMethodDetailsGiftCardBrand = "givex"
	PaymentAttemptRecordPaymentMethodDetailsGiftCardBrandSvs             PaymentAttemptRecordPaymentMethodDetailsGiftCardBrand = "svs"
)
...
const (
	...
	PaymentAttemptRecordProcessorDetailsTypeFiservValuelink PaymentAttemptRecordProcessorDetailsType = "fiserv_valuelink"
	PaymentAttemptRecordProcessorDetailsTypeGivex           PaymentAttemptRecordProcessorDetailsType = "givex"
	PaymentAttemptRecordProcessorDetailsTypeSvs             PaymentAttemptRecordProcessorDetailsType = "svs"
)
...
type PaymentAttemptRecordReportAuthenticatedParams struct {
	...
	AuthenticatedAt *int64 `form:"authenticated_at" json:"authenticated_at,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
...
type PaymentAttemptRecordReportFailedPaymentMethodDetailsCardChecksParams struct {
...
type PaymentAttemptRecordReportFailedPaymentMethodDetailsCardParams struct {
	// Verification checks performed on the card.
	Checks *PaymentAttemptRecordReportFailedPaymentMethodDetailsCardChecksParams `form:"checks" json:"checks,omitempty"`
}
...
type PaymentAttemptRecordReportFailedParams struct {
	...
	PaymentEvaluations []*string `form:"payment_evaluations" json:"payment_evaluations,omitempty"`
	// Information about the Payment Method debited for this payment.
	PaymentMethodDetails *PaymentAttemptRecordReportFailedPaymentMethodDetailsParams `form:"payment_method_details" json:"payment_method_details,omitempty"`
	// Processor information for this payment.
...
type PaymentAttemptRecordReportInformationalParams struct {
	Params `form:"*"`
	// Customer information for this payment.
	CustomerDetails *PaymentAttemptRecordReportInformationalCustomerDetailsParams `form:"customer_details" json:"customer_details,omitempty"`
	...
	Metadata map[string]string `form:"metadata" json:"metadata,omitempty"`
	// Shipping information for this payment.
	ShippingDetails *PaymentAttemptRecordReportInformationalShippingDetailsParams `form:"shipping_details" json:"shipping_details,omitempty"`
...
type PaymentAttemptRecordReportRefundProcessorDetailsParams struct {
	// Information about the custom processor used to make this refund.
	Custom *PaymentAttemptRecordReportRefundProcessorDetailsCustomParams `form:"custom" json:"custom,omitempty"`
	// The type of the processor details. An additional hash is included on processor_details with a name matching this value. It contains additional information specific to the processor.
	Type *string `form:"type" json:"type"`
}
...
type PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticapture struct {
	// Indicates whether or not multiple captures are supported.
	Status PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticaptureStatus `json:"status"`
}
...
type PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorization struct {
	// Indicates whether or not the reauthorization feature is supported.
	Status PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorizationStatus `json:"status"`
}
...
type PaymentAttemptRecordPaymentMethodDetailsCardPresent struct {
	...
	Location     string                                                           `json:"location,omitempty"`
	Multicapture *PaymentAttemptRecordPaymentMethodDetailsCardPresentMulticapture `json:"multicapture,omitempty"`
	// Identifies which network this charge was processed on. Can be `amex`, `cartes_bancaires`, `diners`, `discover`, `eftpos_au`, `interac`, `jcb`, `link`, `mastercard`, `unionpay`, `visa`, or `unknown`.
	...
	// Whether the PaymentIntent can be reauthorized or not.
	Reauthorization *PaymentAttemptRecordPaymentMethodDetailsCardPresentReauthorization `json:"reauthorization,omitempty"`
...
type PaymentAttemptRecordPaymentMethodDetailsGiftCardBalance struct {
	// The balance amount in the smallest currency unit.
	Amount int64 `json:"amount"`
	// The currency of the balance.
	Currency Currency `json:"currency"`
}
type PaymentAttemptRecordPaymentMethodDetailsGiftCard struct {
	// The balance of the gift card after the transaction.
	Balance *PaymentAttemptRecordPaymentMethodDetailsGiftCardBalance `json:"balance"`
	// The brand of the gift card.
	Brand PaymentAttemptRecordPaymentMethodDetailsGiftCardBrand `json:"brand"`
...
type PaymentAttemptRecordPaymentMethodDetailsStripeBalance struct {
...
type PaymentAttemptRecordPaymentMethodDetails struct {
	...
	GiftCard        *PaymentAttemptRecordPaymentMethodDetailsGiftCard        `json:"gift_card,omitempty"`
	Giropay         *PaymentAttemptRecordPaymentMethodDetailsGiropay         `json:"giropay,omitempty"`
	Gopay           *PaymentAttemptRecordPaymentMethodDetailsGopay           `json:"gopay,omitempty"`
	Grabpay         *PaymentAttemptRecordPaymentMethodDetailsGrabpay         `json:"grabpay,omitempty"`
	IDBankTransfer  *PaymentAttemptRecordPaymentMethodDetailsIDBankTransfer  `json:"id_bank_transfer,omitempty"`
	...
	Paypay             *PaymentAttemptRecordPaymentMethodDetailsPaypay             `json:"paypay,omitempty"`
	...
	Qris               *PaymentAttemptRecordPaymentMethodDetailsQris               `json:"qris,omitempty"`
	Rechnung           *PaymentAttemptRecordPaymentMethodDetailsRechnung           `json:"rechnung,omitempty"`
...
type PaymentAttemptRecordProcessorDetailsFiservValuelink struct {
	// An opaque string for manual reconciliation of this payment, for example a check number or a payment processor ID.
	PaymentReference string `json:"payment_reference"`
}

// Represents the Givex gift card processor.
type PaymentAttemptRecordProcessorDetailsGivex struct {
	// An opaque string for manual reconciliation of this payment, for example a check number or a payment processor ID.
	PaymentReference string `json:"payment_reference"`
}

// Represents the SVS gift card processor.
type PaymentAttemptRecordProcessorDetailsSvs struct {
	// An opaque string for manual reconciliation of this payment, for example a check number or a payment processor ID.
	PaymentReference string `json:"payment_reference"`
}
...
type PaymentAttemptRecordProcessorDetails struct {
	...
	// Represents the Fiserv ValueLink gift card processor.
	FiservValuelink *PaymentAttemptRecordProcessorDetailsFiservValuelink `json:"fiserv_valuelink,omitempty"`
	// Represents the Givex gift card processor.
	Givex *PaymentAttemptRecordProcessorDetailsGivex `json:"givex,omitempty"`
	// Represents the SVS gift card processor.
	Svs *PaymentAttemptRecordProcessorDetailsSvs `json:"svs,omitempty"`
	// The processor used for this payment attempt.
