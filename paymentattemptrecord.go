...
type PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceType string

// List of values that PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceType can take
const (
	PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceTypeBankAccount PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceType = "bank_account"
	PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceTypeCard        PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceType = "card"
	PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceTypeFPX         PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceType = "fpx"
)
...
type PaymentAttemptRecordPaymentMethodDetailsStripeBalance struct {
	...
	// The [source_type](https://docs.stripe.com/api/balance/balance_object#balance_object-available-source_types) of the balance
	SourceType PaymentAttemptRecordPaymentMethodDetailsStripeBalanceSourceType `json:"source_type"`
}
