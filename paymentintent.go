...
type PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionInterval string

// List of values that PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionInterval can take
const (
	PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionIntervalDay   PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionInterval = "day"
	PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionIntervalMonth PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionInterval = "month"
	PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionIntervalWeek  PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionInterval = "week"
	PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionIntervalYear  PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionInterval = "year"
)
...
const (
	...
	PaymentIntentPaymentMethodOptionsBLIKMandateOptionsTypeOnSession  PaymentIntentPaymentMethodOptionsBLIKMandateOptionsType = "on_session"
)
...
type PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionParams struct {
	// Frequency interval of each recurring payment.
...
type PaymentIntentPaymentMethodOptionsBLIKMandateOptionsParams struct {
	// Expiry date of the mandate.
	ExpiresAfter *int64 `form:"expires_after"`
	// Details of off-session mandate.
	OffSession *PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionParams `form:"off_session"`
}
...
type PaymentIntentPaymentMethodOptionsBLIKParams struct {
	...
	// Details of the BLIK mandate
	MandateOptions *PaymentIntentPaymentMethodOptionsBLIKMandateOptionsParams `form:"mandate_options"`
}
...
type PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSession struct {
	// Amount of each recurring payment.
	Amount int64 `json:"amount"`
	// Currency of each recurring payment.
	Currency Currency `json:"currency"`
	// Frequency interval of each recurring payment.
	Interval PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSessionInterval `json:"interval"`
	// Frequency indicator of each recurring payment.
...
type PaymentIntentPaymentMethodOptionsBLIKMandateOptions struct {
	...
	ExpiresAfter int64                                                          `json:"expires_after"`
	OffSession   *PaymentIntentPaymentMethodOptionsBLIKMandateOptionsOffSession `json:"off_session"`
	// Type of the mandate.
	Type PaymentIntentPaymentMethodOptionsBLIKMandateOptionsType `json:"type"`
}
type PaymentIntentPaymentMethodOptionsBLIK struct {
	MandateOptions *PaymentIntentPaymentMethodOptionsBLIKMandateOptions `json:"mandate_options"`
}
