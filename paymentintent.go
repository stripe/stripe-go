...
//
// When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](https://docs.stripe.com/strong-customer-authentication).
type PaymentIntentPaymentMethodOptionsStripeBalanceSetupFutureUsage string

// List of values that PaymentIntentPaymentMethodOptionsStripeBalanceSetupFutureUsage can take
const (
...
type PaymentIntentPaymentMethodDataGopayParams struct{}

// If this is a `grabpay` PaymentMethod, this hash contains details about the GrabPay payment method.
type PaymentIntentPaymentMethodDataGrabpayParams struct{}

// If this is an `IdBankTransfer` PaymentMethod, this hash contains details about the IdBankTransfer payment method.
type PaymentIntentPaymentMethodDataIDBankTransferParams struct {
...
type PaymentIntentPaymentMethodDataPaypayParams struct{}

// If this is a `payto` PaymentMethod, this hash contains details about the PayTo payment method.
type PaymentIntentPaymentMethodDataPaytoParams struct {
	// The account number for the bank account.
	AccountNumber *string `form:"account_number"`
	// Bank-State-Branch number of the bank account.
	BSBNumber *string `form:"bsb_number"`
...
type PaymentIntentPaymentMethodDataQrisParams struct{}
...
// Customer's date of birth
type PaymentIntentPaymentMethodDataRechnungDOBParams struct {
	// The day of birth, between 1 and 31.
	Day *int64 `form:"day"`
	// The month of birth, between 1 and 12.
	Month *int64 `form:"month"`
...
type PaymentIntentPaymentMethodDataRechnungParams struct {
	// Customer's date of birth
	DOB *PaymentIntentPaymentMethodDataRechnungDOBParams `form:"dob"`
}
...
type PaymentIntentPaymentMethodDataShopeepayParams struct{}
...
type PaymentIntentPaymentMethodDataStripeBalanceParams struct {
...
type PaymentIntentPaymentMethodDataParams struct {
	...
	// If this is a Gopay PaymentMethod, this hash contains details about the Gopay payment method.
	Gopay *PaymentIntentPaymentMethodDataGopayParams `form:"gopay"`
	// If this is a `grabpay` PaymentMethod, this hash contains details about the GrabPay payment method.
	Grabpay *PaymentIntentPaymentMethodDataGrabpayParams `form:"grabpay"`
	// If this is an `IdBankTransfer` PaymentMethod, this hash contains details about the IdBankTransfer payment method.
	IDBankTransfer *PaymentIntentPaymentMethodDataIDBankTransferParams `form:"id_bank_transfer"`
	// If this is an `ideal` PaymentMethod, this hash contains details about the iDEAL payment method.
	...
	// If this is a `paypay` PaymentMethod, this hash contains details about the PayPay payment method.
	Paypay *PaymentIntentPaymentMethodDataPaypayParams `form:"paypay"`
	// If this is a `payto` PaymentMethod, this hash contains details about the PayTo payment method.
	Payto *PaymentIntentPaymentMethodDataPaytoParams `form:"payto"`
	// If this is a `pix` PaymentMethod, this hash contains details about the Pix payment method.
	...
	// If this is a `qris` PaymentMethod, this hash contains details about the QRIS payment method.
	Qris *PaymentIntentPaymentMethodDataQrisParams `form:"qris"`
	// Options to configure Radar. See [Radar Session](https://stripe.com/docs/radar/radar-session) for more information.
	RadarOptions *PaymentIntentPaymentMethodDataRadarOptionsParams `form:"radar_options"`
	// If this is a `rechnung` PaymentMethod, this hash contains details about the Rechnung payment method.
	Rechnung *PaymentIntentPaymentMethodDataRechnungParams `form:"rechnung"`
	// If this is a `revolut_pay` PaymentMethod, this hash contains details about the Revolut Pay payment method.
	...
	// If this is a Shopeepay PaymentMethod, this hash contains details about the Shopeepay payment method.
	Shopeepay *PaymentIntentPaymentMethodDataShopeepayParams `form:"shopeepay"`
	// If this is a `sofort` PaymentMethod, this hash contains details about the SOFORT payment method.
	Sofort *PaymentIntentPaymentMethodDataSofortParams `form:"sofort"`
	// This hash contains details about the Stripe balance payment method.
	StripeBalance *PaymentIntentPaymentMethodDataStripeBalanceParams `form:"stripe_balance"`
	// If this is a `swish` PaymentMethod, this hash contains details about the Swish payment method.
...
type PaymentIntentPaymentMethodOptionsPixParams struct {
	...
	ExpiresAt *int64 `form:"expires_at"`
	// Additional fields for mandate creation. Only applicable when `setup_future_usage=off_session`.
	MandateOptions *PaymentIntentPaymentMethodOptionsPixMandateOptionsParams `form:"mandate_options"`
	// Indicates that you intend to make future payments with this PaymentIntent's payment method.
	//
	// If you provide a Customer with the PaymentIntent, you can use this parameter to [attach the payment method](https://docs.stripe.com/payments/save-during-payment) to the Customer after the PaymentIntent is confirmed and the customer completes any required actions. If you don't provide a Customer, you can still [attach](https://docs.stripe.com/api/payment_methods/attach) the payment method to a Customer after the transaction completes.
	//
...
type PaymentIntentPaymentMethodOptionsParams struct {
	...
	// If this is a `stripe_balance` PaymentMethod, this sub-hash contains details about the Stripe Balance payment method options.
	StripeBalance *PaymentIntentPaymentMethodOptionsStripeBalanceParams `form:"stripe_balance"`
	// If this is a `Swish` PaymentMethod, this sub-hash contains details about the Swish payment method options.
...
// If this is a Gopay PaymentMethod, this hash contains details about the Gopay payment method.
type PaymentIntentCreatePaymentMethodDataGopayParams struct{}

// If this is a `grabpay` PaymentMethod, this hash contains details about the GrabPay payment method.
type PaymentIntentCreatePaymentMethodDataGrabpayParams struct{}

// If this is an `IdBankTransfer` PaymentMethod, this hash contains details about the IdBankTransfer payment method.
type PaymentIntentCreatePaymentMethodDataIDBankTransferParams struct {
	// Bank where the account is held.
	Bank *string `form:"bank"`
}
...
// If this is a `paypay` PaymentMethod, this hash contains details about the PayPay payment method.
type PaymentIntentCreatePaymentMethodDataPaypayParams struct{}

// If this is a `payto` PaymentMethod, this hash contains details about the PayTo payment method.
type PaymentIntentCreatePaymentMethodDataPaytoParams struct {
	// The account number for the bank account.
	AccountNumber *string `form:"account_number"`
	// Bank-State-Branch number of the bank account.
	BSBNumber *string `form:"bsb_number"`
...
// If this is a `qris` PaymentMethod, this hash contains details about the QRIS payment method.
type PaymentIntentCreatePaymentMethodDataQrisParams struct{}
...
// Customer's date of birth
type PaymentIntentCreatePaymentMethodDataRechnungDOBParams struct {
	// The day of birth, between 1 and 31.
	Day *int64 `form:"day"`
	// The month of birth, between 1 and 12.
	Month *int64 `form:"month"`
...
// If this is a `rechnung` PaymentMethod, this hash contains details about the Rechnung payment method.
type PaymentIntentCreatePaymentMethodDataRechnungParams struct {
	// Customer's date of birth
	DOB *PaymentIntentCreatePaymentMethodDataRechnungDOBParams `form:"dob"`
}
...
// If this is a Shopeepay PaymentMethod, this hash contains details about the Shopeepay payment method.
type PaymentIntentCreatePaymentMethodDataShopeepayParams struct{}
...
// This hash contains details about the Stripe balance payment method.
type PaymentIntentCreatePaymentMethodDataStripeBalanceParams struct {
	// The connected account ID whose Stripe balance to use as the source of payment
	Account *string `form:"account"`
	// The [source_type](https://docs.stripe.com/api/balance/balance_object#balance_object-available-source_types) of the balance
	SourceType *string `form:"source_type"`
...
type PaymentIntentCreatePaymentMethodDataParams struct {
	...
	// If this is a Gopay PaymentMethod, this hash contains details about the Gopay payment method.
	Gopay *PaymentIntentCreatePaymentMethodDataGopayParams `form:"gopay"`
	// If this is a `grabpay` PaymentMethod, this hash contains details about the GrabPay payment method.
	Grabpay *PaymentIntentCreatePaymentMethodDataGrabpayParams `form:"grabpay"`
	// If this is an `IdBankTransfer` PaymentMethod, this hash contains details about the IdBankTransfer payment method.
	IDBankTransfer *PaymentIntentCreatePaymentMethodDataIDBankTransferParams `form:"id_bank_transfer"`
	// If this is an `ideal` PaymentMethod, this hash contains details about the iDEAL payment method.
	...
	// If this is a `paypay` PaymentMethod, this hash contains details about the PayPay payment method.
	Paypay *PaymentIntentCreatePaymentMethodDataPaypayParams `form:"paypay"`
	// If this is a `payto` PaymentMethod, this hash contains details about the PayTo payment method.
	Payto *PaymentIntentCreatePaymentMethodDataPaytoParams `form:"payto"`
	// If this is a `pix` PaymentMethod, this hash contains details about the Pix payment method.
	...
	// If this is a `qris` PaymentMethod, this hash contains details about the QRIS payment method.
	Qris *PaymentIntentCreatePaymentMethodDataQrisParams `form:"qris"`
	// Options to configure Radar. See [Radar Session](https://stripe.com/docs/radar/radar-session) for more information.
	RadarOptions *PaymentIntentCreatePaymentMethodDataRadarOptionsParams `form:"radar_options"`
	// If this is a `rechnung` PaymentMethod, this hash contains details about the Rechnung payment method.
	Rechnung *PaymentIntentCreatePaymentMethodDataRechnungParams `form:"rechnung"`
	// If this is a `revolut_pay` PaymentMethod, this hash contains details about the Revolut Pay payment method.
	...
	// If this is a Shopeepay PaymentMethod, this hash contains details about the Shopeepay payment method.
	Shopeepay *PaymentIntentCreatePaymentMethodDataShopeepayParams `form:"shopeepay"`
	// If this is a `sofort` PaymentMethod, this hash contains details about the SOFORT payment method.
	Sofort *PaymentIntentCreatePaymentMethodDataSofortParams `form:"sofort"`
	// This hash contains details about the Stripe balance payment method.
	StripeBalance *PaymentIntentCreatePaymentMethodDataStripeBalanceParams `form:"stripe_balance"`
	// If this is a `swish` PaymentMethod, this hash contains details about the Swish payment method.
...
type PaymentIntentCreatePaymentMethodOptionsPixParams struct {
	...
	ExpiresAt *int64 `form:"expires_at"`
	// Additional fields for mandate creation. Only applicable when `setup_future_usage=off_session`.
	MandateOptions *PaymentIntentCreatePaymentMethodOptionsPixMandateOptionsParams `form:"mandate_options"`
	// Indicates that you intend to make future payments with this PaymentIntent's payment method.
	//
	// If you provide a Customer with the PaymentIntent, you can use this parameter to [attach the payment method](https://docs.stripe.com/payments/save-during-payment) to the Customer after the PaymentIntent is confirmed and the customer completes any required actions. If you don't provide a Customer, you can still [attach](https://docs.stripe.com/api/payment_methods/attach) the payment method to a Customer after the transaction completes.
	//
...
// If this is a Gopay PaymentMethod, this hash contains details about the Gopay payment method.
type PaymentIntentUpdatePaymentMethodDataGopayParams struct{}

// If this is a `grabpay` PaymentMethod, this hash contains details about the GrabPay payment method.
type PaymentIntentUpdatePaymentMethodDataGrabpayParams struct{}

// If this is an `IdBankTransfer` PaymentMethod, this hash contains details about the IdBankTransfer payment method.
type PaymentIntentUpdatePaymentMethodDataIDBankTransferParams struct {
	// Bank where the account is held.
	Bank *string `form:"bank"`
}
...
// If this is a `paypay` PaymentMethod, this hash contains details about the PayPay payment method.
type PaymentIntentUpdatePaymentMethodDataPaypayParams struct{}

// If this is a `payto` PaymentMethod, this hash contains details about the PayTo payment method.
type PaymentIntentUpdatePaymentMethodDataPaytoParams struct {
	// The account number for the bank account.
	AccountNumber *string `form:"account_number"`
	// Bank-State-Branch number of the bank account.
	BSBNumber *string `form:"bsb_number"`
...
// If this is a `qris` PaymentMethod, this hash contains details about the QRIS payment method.
type PaymentIntentUpdatePaymentMethodDataQrisParams struct{}
...
// Customer's date of birth
type PaymentIntentUpdatePaymentMethodDataRechnungDOBParams struct {
	// The day of birth, between 1 and 31.
	Day *int64 `form:"day"`
	// The month of birth, between 1 and 12.
	Month *int64 `form:"month"`
...
// If this is a `rechnung` PaymentMethod, this hash contains details about the Rechnung payment method.
type PaymentIntentUpdatePaymentMethodDataRechnungParams struct {
	// Customer's date of birth
	DOB *PaymentIntentUpdatePaymentMethodDataRechnungDOBParams `form:"dob"`
}
...
// If this is a Shopeepay PaymentMethod, this hash contains details about the Shopeepay payment method.
type PaymentIntentUpdatePaymentMethodDataShopeepayParams struct{}
...
// This hash contains details about the Stripe balance payment method.
type PaymentIntentUpdatePaymentMethodDataStripeBalanceParams struct {
	// The connected account ID whose Stripe balance to use as the source of payment
	Account *string `form:"account"`
	// The [source_type](https://docs.stripe.com/api/balance/balance_object#balance_object-available-source_types) of the balance
	SourceType *string `form:"source_type"`
...
type PaymentIntentUpdatePaymentMethodDataParams struct {
	...
	// If this is a Gopay PaymentMethod, this hash contains details about the Gopay payment method.
	Gopay *PaymentIntentUpdatePaymentMethodDataGopayParams `form:"gopay"`
	// If this is a `grabpay` PaymentMethod, this hash contains details about the GrabPay payment method.
	Grabpay *PaymentIntentUpdatePaymentMethodDataGrabpayParams `form:"grabpay"`
	// If this is an `IdBankTransfer` PaymentMethod, this hash contains details about the IdBankTransfer payment method.
	IDBankTransfer *PaymentIntentUpdatePaymentMethodDataIDBankTransferParams `form:"id_bank_transfer"`
	// If this is an `ideal` PaymentMethod, this hash contains details about the iDEAL payment method.
	...
	// If this is a `paypay` PaymentMethod, this hash contains details about the PayPay payment method.
	Paypay *PaymentIntentUpdatePaymentMethodDataPaypayParams `form:"paypay"`
	// If this is a `payto` PaymentMethod, this hash contains details about the PayTo payment method.
	Payto *PaymentIntentUpdatePaymentMethodDataPaytoParams `form:"payto"`
	// If this is a `pix` PaymentMethod, this hash contains details about the Pix payment method.
	...
	// If this is a `qris` PaymentMethod, this hash contains details about the QRIS payment method.
	Qris *PaymentIntentUpdatePaymentMethodDataQrisParams `form:"qris"`
	// Options to configure Radar. See [Radar Session](https://stripe.com/docs/radar/radar-session) for more information.
	RadarOptions *PaymentIntentUpdatePaymentMethodDataRadarOptionsParams `form:"radar_options"`
	// If this is a `rechnung` PaymentMethod, this hash contains details about the Rechnung payment method.
	Rechnung *PaymentIntentUpdatePaymentMethodDataRechnungParams `form:"rechnung"`
	// If this is a `revolut_pay` PaymentMethod, this hash contains details about the Revolut Pay payment method.
	...
	// If this is a Shopeepay PaymentMethod, this hash contains details about the Shopeepay payment method.
	Shopeepay *PaymentIntentUpdatePaymentMethodDataShopeepayParams `form:"shopeepay"`
	// If this is a `sofort` PaymentMethod, this hash contains details about the SOFORT payment method.
	Sofort *PaymentIntentUpdatePaymentMethodDataSofortParams `form:"sofort"`
	// This hash contains details about the Stripe balance payment method.
	StripeBalance *PaymentIntentUpdatePaymentMethodDataStripeBalanceParams `form:"stripe_balance"`
	// If this is a `swish` PaymentMethod, this hash contains details about the Swish payment method.
...
type PaymentIntentUpdatePaymentMethodOptionsPixParams struct {
	...
	ExpiresAt *int64 `form:"expires_at"`
	// Additional fields for mandate creation. Only applicable when `setup_future_usage=off_session`.
	MandateOptions *PaymentIntentUpdatePaymentMethodOptionsPixMandateOptionsParams `form:"mandate_options"`
	// Indicates that you intend to make future payments with this PaymentIntent's payment method.
	//
	// If you provide a Customer with the PaymentIntent, you can use this parameter to [attach the payment method](https://docs.stripe.com/payments/save-during-payment) to the Customer after the PaymentIntent is confirmed and the customer completes any required actions. If you don't provide a Customer, you can still [attach](https://docs.stripe.com/api/payment_methods/attach) the payment method to a Customer after the transaction completes.
	//
...
type PaymentIntentPaymentMethodOptionsPixMandateOptions struct {
	...
	Amount int64 `json:"amount"`
	// Determines if the amount includes the IOF tax.
	AmountIncludesIof PaymentIntentPaymentMethodOptionsPixMandateOptionsAmountIncludesIof `json:"amount_includes_iof"`
	// Type of amount.
	AmountType PaymentIntentPaymentMethodOptionsPixMandateOptionsAmountType `json:"amount_type"`
	// Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase.
	Currency Currency `json:"currency"`
	// Date when the mandate expires and no further payments will be charged, in `YYYY-MM-DD`.
	EndDate string `json:"end_date"`
	// Schedule at which the future payments will be charged.
	PaymentSchedule PaymentIntentPaymentMethodOptionsPixMandateOptionsPaymentSchedule `json:"payment_schedule"`
...
type PaymentIntentPaymentMethodOptionsPix struct {
	...
	ExpiresAt      int64                                               `json:"expires_at"`
	MandateOptions *PaymentIntentPaymentMethodOptionsPixMandateOptions `json:"mandate_options"`
	// Indicates that you intend to make future payments with this PaymentIntent's payment method.
	//
	// If you provide a Customer with the PaymentIntent, you can use this parameter to [attach the payment method](https://docs.stripe.com/payments/save-during-payment) to the Customer after the PaymentIntent is confirmed and the customer completes any required actions. If you don't provide a Customer, you can still [attach](https://docs.stripe.com/api/payment_methods/attach) the payment method to a Customer after the transaction completes.
	//
...
type PaymentIntentPaymentMethodOptionsStripeBalance struct {
	...
	//
	// When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](https://docs.stripe.com/strong-customer-authentication).
	SetupFutureUsage PaymentIntentPaymentMethodOptionsStripeBalanceSetupFutureUsage `json:"setup_future_usage"`
}
...
type PaymentIntentPaymentMethodOptions struct {
	...
	StripeBalance    *PaymentIntentPaymentMethodOptionsStripeBalance    `json:"stripe_balance"`
