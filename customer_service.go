...
// Returns a list of your customers. The customers are returned sorted by creation date, with the most recent customers appearing first.
func (c v1CustomerService) ListWithPage(ctx context.Context, listParams *CustomerListParams) *V1List[*Customer] {
	if listParams == nil {
...
func (c v1CustomerService) ListPaymentMethods(ctx context.Context, listParams *CustomerListPaymentMethodsParams) Seq2[*PaymentMethod, error] {
	return c.ListPaymentMethodsWithPage(ctx, listParams).All()
}

// Returns a list of PaymentMethods for a given Customer
func (c v1CustomerService) ListPaymentMethodsWithPage(ctx context.Context, listParams *CustomerListPaymentMethodsParams) *V1List[*PaymentMethod] {
	if listParams == nil {
...
func (c v1CustomerService) Search(ctx context.Context, params *CustomerSearchParams) Seq2[*Customer, error] {
	return c.SearchWithPage(ctx, params).All()
}
...
// conditions, data is searchable in less than a minute. Occasionally, propagation of new or updated data can be up
// to an hour behind during outages. Search functionality is not available to merchants in India.
func (c v1CustomerService) SearchWithPage(ctx context.Context, params *CustomerSearchParams) *V1SearchList[*Customer] {
	if params == nil {
