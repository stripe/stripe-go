...
type ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetailsCardPresent struct {
	...
	// Whether the PaymentIntent can be reauthorized or not.
	Reauthorization *ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetailsCardPresentReauthorization `json:"reauthorization,omitempty"`
...
type ConfirmationTokenPaymentMethodPreviewCard struct {
	Benefits *ConfirmationTokenPaymentMethodPreviewCardBenefits `json:"benefits,omitempty"`
	// Card brand. Can be `amex`, `cartes_bancaires`, `diners`, `discover`, `eftpos_au`, `jcb`, `link`, `mastercard`, `unionpay`, `visa` or `unknown`.
	Brand string `json:"brand"`
	// Checks on Card address and CVC if provided.
...
type ConfirmationTokenPaymentMethodPreviewRechnung struct {
	DOB *ConfirmationTokenPaymentMethodPreviewRechnungDOB `json:"dob,omitempty"`
}
...
type ConfirmationTokenPaymentMethodPreview struct {
	...
	IDBankTransfer  *ConfirmationTokenPaymentMethodPreviewIDBankTransfer  `json:"id_bank_transfer,omitempty"`
	...
	Qris            *ConfirmationTokenPaymentMethodPreviewQris            `json:"qris,omitempty"`
	Rechnung        *ConfirmationTokenPaymentMethodPreviewRechnung        `json:"rechnung,omitempty"`
