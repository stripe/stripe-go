...
func (c v1AccountService) MarshalBatchCreate(params *AccountCreateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1AccountService) MarshalBatchDelete(id string, params *AccountDeleteParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1AccountService) MarshalBatchUpdate(id string, params *AccountUpdateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
