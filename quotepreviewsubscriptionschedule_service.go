...
func (c v1QuotePreviewSubscriptionScheduleService) List(ctx context.Context, listParams *QuotePreviewSubscriptionScheduleListParams) *V1List[*QuotePreviewSubscriptionSchedule] {
	if listParams == nil {
