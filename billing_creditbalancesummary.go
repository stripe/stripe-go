...
type BillingCreditBalanceSummaryBalanceAvailableBalance struct {
	// The custom pricing unit amount.
	CustomPricingUnit *BillingCreditBalanceSummaryBalanceAvailableBalanceCustomPricingUnit `json:"custom_pricing_unit,omitempty"`
	// The monetary amount.
...
type BillingCreditBalanceSummaryBalanceLedgerBalance struct {
	// The custom pricing unit amount.
	CustomPricingUnit *BillingCreditBalanceSummaryBalanceLedgerBalanceCustomPricingUnit `json:"custom_pricing_unit,omitempty"`
	// The monetary amount.
...
type BillingCreditBalanceSummaryBalance struct {
	...
	BalanceUpdateDetails *BillingCreditBalanceSummaryBalanceBalanceUpdateDetails `json:"balance_update_details,omitempty"`
