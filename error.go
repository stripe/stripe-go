...
const (
	...
	ErrorTypeFxQuoteNeedsRefresh           ErrorType = "fx_quote_needs_refresh"
...
const (
	...
	ErrorCodeAnomalousMoneyMovementRequest                               ErrorCode = "anomalous_money_movement_request"
	...
	ErrorCodeCapabilityNotActive                                         ErrorCode = "capability_not_active"
	...
	ErrorCodeFailedTaxCalculation                                        ErrorCode = "failed_tax_calculation"
	ErrorCodeFinancialAccountBalanceDoesNotSupportCurrency               ErrorCode = "financial_account_balance_does_not_support_currency"
	ErrorCodeFinancialAccountCapabilityNotEnabled                        ErrorCode = "financial_account_capability_not_enabled"
	ErrorCodeFinancialAccountCapabilityRestricted                        ErrorCode = "financial_account_capability_restricted"
	...
	ErrorCodeIncorrectPostalCode                                         ErrorCode = "incorrect_postal_code"
	...
	ErrorCodeInvalidCanceledSubscriptionFields                           ErrorCode = "invalid_canceled_subscription_fields"
	...
	ErrorCodePaymentMethodMicrodepositProcessingError                    ErrorCode = "payment_method_microdeposit_processing_error"
	...
	ErrorCodePaymentMethodRestricted                                     ErrorCode = "payment_method_restricted"
	...
	ErrorCodeSiretInvalid                                                ErrorCode = "siret_invalid"
...
// FxQuoteNeedsRefreshError is the Go struct corresponding to the error type "fx_quote_needs_refresh".
// Error returned when the FX quote rate lock for a PayoutIntent has expired.
type FxQuoteNeedsRefreshError struct {
	APIResource
	Code        string    `json:"code"`
	DocURL      *string   `json:"doc_url,omitempty"`
	Message     string    `json:"message"`
...
// Error serializes the error object to JSON and returns it as a string.
func (e *FxQuoteNeedsRefreshError) Error() string {
	ret, _ := json.Marshal(e)
	return string(ret)
}

// redact implements the redacter interface.
func (e *FxQuoteNeedsRefreshError) redact() error {
	return e
}

// canRetry implements the retrier interface.
func (e *FxQuoteNeedsRefreshError) canRetry() bool {
	return false
}
