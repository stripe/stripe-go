...
// Returns a list of VerificationSessions
func (c v1IdentityVerificationSessionService) ListWithPage(ctx context.Context, listParams *IdentityVerificationSessionListParams) *V1List[*IdentityVerificationSession] {
	if listParams == nil {
