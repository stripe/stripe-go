...
const (
	...
	InvoiceAutomaticTaxLiabilityTypeApplication InvoiceAutomaticTaxLiabilityType = "application"
...
const (
	...
	InvoiceIssuerTypeApplication InvoiceIssuerType = "application"
	InvoiceIssuerTypeSelf        InvoiceIssuerType = "self"
)

// The payment collection behavior for this subscription while paused.
type InvoiceParentSubscriptionDetailsPauseCollectionBehavior string

// List of values that InvoiceParentSubscriptionDetailsPauseCollectionBehavior can take
const (
	InvoiceParentSubscriptionDetailsPauseCollectionBehaviorKeepAsDraft       InvoiceParentSubscriptionDetailsPauseCollectionBehavior = "keep_as_draft"
	InvoiceParentSubscriptionDetailsPauseCollectionBehaviorMarkUncollectible InvoiceParentSubscriptionDetailsPauseCollectionBehavior = "mark_uncollectible"
	InvoiceParentSubscriptionDetailsPauseCollectionBehaviorVoid              InvoiceParentSubscriptionDetailsPauseCollectionBehavior = "void"
)
...
const (
	...
	InvoicePaymentSettingsPaymentMethodTypeCheckScan          InvoicePaymentSettingsPaymentMethodType = "check_scan"
	...
	InvoicePaymentSettingsPaymentMethodTypePaypay             InvoicePaymentSettingsPaymentMethodType = "paypay"
	...
	InvoicePaymentSettingsPaymentMethodTypeVipps              InvoicePaymentSettingsPaymentMethodType = "vipps"
...
type InvoiceParams struct {
	...
	ManagedPayments *InvoiceManagedPaymentsParams `form:"managed_payments" json:"managed_payments,omitempty"`
...
const (
	...
	InvoiceParamsUnsetFieldAmountsDue      InvoiceParamsUnsetField = "amounts_due"
	InvoiceParamsUnsetFieldCustomFields    InvoiceParamsUnsetField = "custom_fields"
	InvoiceParamsUnsetFieldDefaultMargins  InvoiceParamsUnsetField = "default_margins"
...
type InvoicePaymentSettingsPaymentMethodOptionsParams struct {
	...
	// If paying by `check_scan`, this sub-hash contains details about the Check Scan payment method options to pass to the invoice's PaymentIntent.
	CheckScan *InvoicePaymentSettingsPaymentMethodOptionsCheckScanParams `form:"check_scan" json:"check_scan,omitempty"`
	// If paying by `customer_balance`, this sub-hash contains details about the Bank transfer payment method options to pass to the invoice's PaymentIntent.
...
// Settings for Managed Payments for this invoice.
type InvoiceManagedPaymentsParams struct {
...
type InvoiceAddLinesLinePriceDataProductDataTaxDetailsParams struct {
	...
	TaxCode     *string                                                             `form:"tax_code" json:"tax_code,omitempty"`
	UnsetFields []InvoiceAddLinesLinePriceDataProductDataTaxDetailsParamsUnsetField `form:"-" json:"-"`
}

// InvoiceAddLinesLinePriceDataProductDataTaxDetailsParamsUnsetField is the list of fields that can be cleared/unset on InvoiceAddLinesLinePriceDataProductDataTaxDetailsParams.
type InvoiceAddLinesLinePriceDataProductDataTaxDetailsParamsUnsetField string

const (
	InvoiceAddLinesLinePriceDataProductDataTaxDetailsParamsUnsetFieldTaxCode InvoiceAddLinesLinePriceDataProductDataTaxDetailsParamsUnsetField = "tax_code"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *InvoiceAddLinesLinePriceDataProductDataTaxDetailsParams) AddUnsetField(field InvoiceAddLinesLinePriceDataProductDataTaxDetailsParamsUnsetField) {
	p.UnsetFields = append(p.UnsetFields, field)
}
...
const (
	...
	InvoiceAddLinesLineParamsUnsetFieldMargins    InvoiceAddLinesLineParamsUnsetField = "margins"
...
// InvoiceAttachPaymentPaymentRecordDataParamsUnsetField is the list of fields that can be cleared/unset on InvoiceAttachPaymentPaymentRecordDataParams.
type InvoiceAttachPaymentPaymentRecordDataParamsUnsetField string

const (
	InvoiceAttachPaymentPaymentRecordDataParamsUnsetFieldMetadata InvoiceAttachPaymentPaymentRecordDataParamsUnsetField = "metadata"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *InvoiceAttachPaymentPaymentRecordDataParams) AddUnsetField(field InvoiceAttachPaymentPaymentRecordDataParamsUnsetField) {
	p.UnsetFields = append(p.UnsetFields, field)
}
...
// AddExpand appends a new field to expand.
func (p *InvoiceDetachPaymentParams) AddExpand(f string) {
	p.Expand = append(p.Expand, &f)
}
...
type InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParams struct {
	...
	// A [tax code](https://docs.stripe.com/tax/tax-categories) ID.
	TaxCode     *string                                                                `form:"tax_code" json:"tax_code,omitempty"`
	UnsetFields []InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParamsUnsetField `form:"-" json:"-"`
}

// InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParamsUnsetField is the list of fields that can be cleared/unset on InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParams.
type InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParamsUnsetField string

const (
	InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParamsUnsetFieldTaxCode InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParamsUnsetField = "tax_code"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParams) AddUnsetField(field InvoiceUpdateLinesLinePriceDataProductDataTaxDetailsParamsUnsetField) {
	p.UnsetFields = append(p.UnsetFields, field)
}
...
const (
	...
	InvoiceUpdateLinesLineParamsUnsetFieldMargins    InvoiceUpdateLinesLineParamsUnsetField = "margins"
...
// InvoiceCreatePreviewScheduleDetailsAmendmentMetadataActionParamsUnsetField is the list of fields that can be cleared/unset on InvoiceCreatePreviewScheduleDetailsAmendmentMetadataActionParams.
type InvoiceCreatePreviewScheduleDetailsAmendmentMetadataActionParamsUnsetField string

const (
	InvoiceCreatePreviewScheduleDetailsAmendmentMetadataActionParamsUnsetFieldSet InvoiceCreatePreviewScheduleDetailsAmendmentMetadataActionParamsUnsetField = "set"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *InvoiceCreatePreviewScheduleDetailsAmendmentMetadataActionParams) AddUnsetField(field InvoiceCreatePreviewScheduleDetailsAmendmentMetadataActionParamsUnsetField) {
	p.UnsetFields = append(p.UnsetFields, field)
}
...
// InvoiceCreatePreviewScheduleDetailsParamsUnsetField is the list of fields that can be cleared/unset on InvoiceCreatePreviewScheduleDetailsParams.
type InvoiceCreatePreviewScheduleDetailsParamsUnsetField string

const (
	InvoiceCreatePreviewScheduleDetailsParamsUnsetFieldBillingSchedules InvoiceCreatePreviewScheduleDetailsParamsUnsetField = "billing_schedules"
	InvoiceCreatePreviewScheduleDetailsParamsUnsetFieldPrebilling       InvoiceCreatePreviewScheduleDetailsParamsUnsetField = "prebilling"
)

// AddUnsetField adds a field to the list of fields to clear/unset on this params object.
func (p *InvoiceCreatePreviewScheduleDetailsParams) AddUnsetField(field InvoiceCreatePreviewScheduleDetailsParamsUnsetField) {
	p.UnsetFields = append(p.UnsetFields, field)
}
...
const (
	...
	InvoiceCreatePreviewSubscriptionDetailsParamsUnsetFieldMetadata         InvoiceCreatePreviewSubscriptionDetailsParamsUnsetField = "metadata"
)
...
// AddMetadata adds a new key-value pair to the Metadata.
func (p *InvoiceCreatePreviewSubscriptionDetailsParams) AddMetadata(key string, value string) {
	if p.Metadata == nil {
		p.Metadata = make(map[string]string)
	}
...
type InvoiceUpdatePaymentSettingsPaymentMethodOptionsParams struct {
	...
	// If paying by `check_scan`, this sub-hash contains details about the Check Scan payment method options to pass to the invoice's PaymentIntent.
	CheckScan *InvoiceUpdatePaymentSettingsPaymentMethodOptionsCheckScanParams `form:"check_scan" json:"check_scan,omitempty"`
	// If paying by `customer_balance`, this sub-hash contains details about the Bank transfer payment method options to pass to the invoice's PaymentIntent.
...
const (
	...
	InvoiceUpdateParamsUnsetFieldAmountsDue      InvoiceUpdateParamsUnsetField = "amounts_due"
	InvoiceUpdateParamsUnsetFieldCustomFields    InvoiceUpdateParamsUnsetField = "custom_fields"
	InvoiceUpdateParamsUnsetFieldDefaultMargins  InvoiceUpdateParamsUnsetField = "default_margins"
...
// Settings for Managed Payments for this invoice.
type InvoiceCreateManagedPaymentsParams struct {
	// Set to `true` to enable [Managed Payments](https://docs.stripe.com/payments/managed-payments), Stripe's merchant of record solution.
	Enabled *bool `form:"enabled" json:"enabled,omitempty"`
}
...
type InvoiceCreatePaymentSettingsPaymentMethodOptionsParams struct {
	...
	// If paying by `check_scan`, this sub-hash contains details about the Check Scan payment method options to pass to the invoice's PaymentIntent.
	CheckScan *InvoiceCreatePaymentSettingsPaymentMethodOptionsCheckScanParams `form:"check_scan" json:"check_scan,omitempty"`
	// If paying by `customer_balance`, this sub-hash contains details about the Bank transfer payment method options to pass to the invoice's PaymentIntent.
...
type InvoiceCreateParams struct {
	...
	// Settings for Managed Payments for this invoice.
	ManagedPayments *InvoiceCreateManagedPaymentsParams `form:"managed_payments" json:"managed_payments,omitempty"`
	// Set of [key-value pairs](https://docs.stripe.com/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
	Metadata map[string]string `form:"metadata" json:"metadata,omitempty"`
	// Set the number for this invoice. If no number is present then a number will be assigned automatically when the invoice is finalized. In many markets, regulations require invoices to be unique, sequential and / or gapless. You are responsible for ensuring this is true across all your different invoicing systems in the event that you edit the invoice number using our API. If you use only Stripe for your invoices and do not change invoice numbers, Stripe handles this aspect of compliance for you automatically.
	Number *string `form:"number" json:"number,omitempty"`
...
const (
	...
	InvoiceCreateParamsUnsetFieldAmountsDue    InvoiceCreateParamsUnsetField = "amounts_due"
...
type InvoiceCustomerBalance struct {
	...
	AutomaticallyAppliedBalance int64 `json:"automatically_applied_balance"`
	// The total amount of customer balance manually applied after finalization.
	ManuallyAppliedBalance int64 `json:"manually_applied_balance"`
}
...
type InvoiceManagedPayments struct {
...
type InvoiceParentSubscriptionDetailsPauseCollection struct {
	// The payment collection behavior for this subscription while paused.
	Behavior InvoiceParentSubscriptionDetailsPauseCollectionBehavior `json:"behavior"`
...
type InvoicePaymentSettingsPaymentMethodOptions struct {
	...
	// If paying by `check_scan`, this sub-hash contains details about the Check Scan payment method options to pass to the invoice's PaymentIntent.
	CheckScan *InvoicePaymentSettingsPaymentMethodOptionsCheckScan `json:"check_scan,omitempty"`
	// If paying by `customer_balance`, this sub-hash contains details about the Bank transfer payment method options to pass to the invoice's PaymentIntent.
...
type Invoice struct {
	...
	// The customer balance amounts applied to this invoice.
	CustomerBalance *InvoiceCustomerBalance `json:"customer_balance,omitempty"`
	...
	ManagedPayments *InvoiceManagedPayments `json:"managed_payments,omitempty"`
