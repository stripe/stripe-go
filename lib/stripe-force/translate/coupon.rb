  ...
  def get_salesforce_stripe_coupons_associated_to_sf_object(sf_client:, sf_object:)
    catch_errors_with_salesforce_context(secondary: sf_object) do
      ...
      if associations.size != coupon_data.size
        ...
        raise Integrations::Errors::UserError.new("Connector Error: There is different number of Quote or Quote Line Associations than Order or Order Item coupons.")
      end
