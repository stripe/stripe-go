...
type QuotePreviewSubscriptionScheduleDefaultSettingsInvoiceSettingsCustomField struct {
...
type QuotePreviewSubscriptionScheduleDefaultSettingsInvoiceSettings struct {
	...
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*QuotePreviewSubscriptionScheduleDefaultSettingsInvoiceSettingsCustomField `json:"custom_fields"`
...
// A list of up to 4 custom fields to be displayed on the invoice.
type QuotePreviewSubscriptionSchedulePhaseInvoiceSettingsCustomField struct {
	// The name of the custom field.
	Name string `json:"name"`
	// The value of the custom field.
	Value string `json:"value"`
...
type QuotePreviewSubscriptionSchedulePhaseInvoiceSettings struct {
	...
	AccountTaxIDs []*TaxID `json:"account_tax_ids"`
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*QuotePreviewSubscriptionSchedulePhaseInvoiceSettingsCustomField `json:"custom_fields"`
	// Number of days within which a customer must pay invoices generated by this subscription schedule. This value will be `null` for subscription schedules where `billing=charge_automatically`.
	DaysUntilDue int64 `json:"days_until_due"`
	// An arbitrary string attached to the object. Often useful for displaying to users.
	Description string `json:"description"`
