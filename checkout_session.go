...
const (
	...
	CheckoutSessionCollectedInformationTaxIDTypeAlTin    CheckoutSessionCollectedInformationTaxIDType = "al_tin"
	CheckoutSessionCollectedInformationTaxIDTypeAmTin    CheckoutSessionCollectedInformationTaxIDType = "am_tin"
	CheckoutSessionCollectedInformationTaxIDTypeAoTin    CheckoutSessionCollectedInformationTaxIDType = "ao_tin"
	...
	CheckoutSessionCollectedInformationTaxIDTypeBsTin    CheckoutSessionCollectedInformationTaxIDType = "bs_tin"
	CheckoutSessionCollectedInformationTaxIDTypeByTin    CheckoutSessionCollectedInformationTaxIDType = "by_tin"
	...
	CheckoutSessionCollectedInformationTaxIDTypeCdNif    CheckoutSessionCollectedInformationTaxIDType = "cd_nif"
	...
	CheckoutSessionCollectedInformationTaxIDTypeFoVAT    CheckoutSessionCollectedInformationTaxIDType = "fo_vat"
	...
	CheckoutSessionCollectedInformationTaxIDTypeGiTin    CheckoutSessionCollectedInformationTaxIDType = "gi_tin"
	CheckoutSessionCollectedInformationTaxIDTypeGnNif    CheckoutSessionCollectedInformationTaxIDType = "gn_nif"
	...
	CheckoutSessionCollectedInformationTaxIDTypeIcNif    CheckoutSessionCollectedInformationTaxIDType = "ic_nif"
	...
	CheckoutSessionCollectedInformationTaxIDTypeITCf     CheckoutSessionCollectedInformationTaxIDType = "it_cf"
	...
	CheckoutSessionCollectedInformationTaxIDTypeMkVAT    CheckoutSessionCollectedInformationTaxIDType = "mk_vat"
	CheckoutSessionCollectedInformationTaxIDTypeMrNif    CheckoutSessionCollectedInformationTaxIDType = "mr_nif"
	...
	CheckoutSessionCollectedInformationTaxIDTypeNpPan    CheckoutSessionCollectedInformationTaxIDType = "np_pan"
	...
	CheckoutSessionCollectedInformationTaxIDTypePyRuc    CheckoutSessionCollectedInformationTaxIDType = "py_ruc"
	...
	CheckoutSessionCollectedInformationTaxIDTypeSnNinea  CheckoutSessionCollectedInformationTaxIDType = "sn_ninea"
	CheckoutSessionCollectedInformationTaxIDTypeSrFin    CheckoutSessionCollectedInformationTaxIDType = "sr_fin"
	...
	CheckoutSessionCollectedInformationTaxIDTypeTjTin    CheckoutSessionCollectedInformationTaxIDType = "tj_tin"
	...
	CheckoutSessionCollectedInformationTaxIDTypeTzVAT    CheckoutSessionCollectedInformationTaxIDType = "tz_vat"
	CheckoutSessionCollectedInformationTaxIDTypeUAVAT    CheckoutSessionCollectedInformationTaxIDType = "ua_vat"
	CheckoutSessionCollectedInformationTaxIDTypeUgTin    CheckoutSessionCollectedInformationTaxIDType = "ug_tin"
	...
	CheckoutSessionCollectedInformationTaxIDTypeUzTin    CheckoutSessionCollectedInformationTaxIDType = "uz_tin"
	CheckoutSessionCollectedInformationTaxIDTypeUzVAT    CheckoutSessionCollectedInformationTaxIDType = "uz_vat"
	...
	CheckoutSessionCollectedInformationTaxIDTypeZmTin    CheckoutSessionCollectedInformationTaxIDType = "zm_tin"
	CheckoutSessionCollectedInformationTaxIDTypeZwTin    CheckoutSessionCollectedInformationTaxIDType = "zw_tin"
)
...
const (
	...
	CheckoutSessionCustomerDetailsTaxIDTypeIcNif    CheckoutSessionCustomerDetailsTaxIDType = "ic_nif"
...
type CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalInterval string

// List of values that CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalInterval can take
const (
	CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalIntervalDay   CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalInterval = "day"
	CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalIntervalMonth CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalInterval = "month"
	CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalIntervalWeek  CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalInterval = "week"
	CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalIntervalYear  CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalInterval = "year"
)

// Determines how to handle prorations when the subscription is updated.
type CheckoutSessionItemSubscriptionProrationBehavior string

// List of values that CheckoutSessionItemSubscriptionProrationBehavior can take
const (
	CheckoutSessionItemSubscriptionProrationBehaviorCreateProrations CheckoutSessionItemSubscriptionProrationBehavior = "create_prorations"
...
// List of values that CheckoutSessionItemSubscriptionTrialSettingsEndBehaviorMissingPaymentMethod can take
const (
	CheckoutSessionItemSubscriptionTrialSettingsEndBehaviorMissingPaymentMethodCancel        CheckoutSessionItemSubscriptionTrialSettingsEndBehaviorMissingPaymentMethod = "cancel"
	CheckoutSessionItemSubscriptionTrialSettingsEndBehaviorMissingPaymentMethodCreateInvoice CheckoutSessionItemSubscriptionTrialSettingsEndBehaviorMissingPaymentMethod = "create_invoice"
	CheckoutSessionItemSubscriptionTrialSettingsEndBehaviorMissingPaymentMethodPause         CheckoutSessionItemSubscriptionTrialSettingsEndBehaviorMissingPaymentMethod = "pause"
)
...
const (
	CheckoutSessionCheckoutItemTypeRateCardSubscriptionItem    CheckoutSessionCheckoutItemType = "rate_card_subscription_item"
	CheckoutSessionCheckoutItemTypePricingPlanSubscriptionItem CheckoutSessionCheckoutItemType = "pricing_plan_subscription_item"
)

type CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsType string

// List of values that CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsType can take
const (
	CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsTypeLicenseFeeComponent CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsType = "license_fee_component"
)
...
type CheckoutSessionAutomaticTaxParams struct {
	...
	AddressCollectionPrecision *string `form:"address_collection_precision" json:"address_collection_precision,omitempty"`
...
type CheckoutSessionDiscountParams struct {
	...
	// Data used to generate a new [Coupon](https://docs.stripe.com/api/coupon) object inline. One of `coupon` or `coupon_data` is required when updating discounts.
	CouponData *CheckoutSessionDiscountCouponDataParams `form:"coupon_data" json:"coupon_data,omitempty"`
...
type CheckoutSessionPermissionsUpdateParams struct {
	...
	//
	// When set to `server_only`, you must add the onLineItemsChange event handler when initializing the Stripe Checkout client and manually update the line items from your server using the Stripe API.
	LineItems *string `form:"line_items" json:"line_items,omitempty"`
	// Determines which entity is allowed to update the shipping details.
	//
	// Default is `client_only`. Stripe Checkout client will automatically update the shipping details. If set to `server_only`, only your server is allowed to update the shipping details.
	//
...
type CheckoutSessionPermissionsParams struct {
	// Permissions for updating the Checkout Session.
	Update *CheckoutSessionPermissionsUpdateParams `form:"update" json:"update,omitempty"`
	...
	UpdateDiscounts *string `form:"update_discounts" json:"update_discounts,omitempty"`
	// Determines which entity is allowed to update the line items.
	//
	// Default is `client_only`. Stripe Checkout client will automatically update the line items. If set to `server_only`, only your server is allowed to update the line items.
	//
	// When set to `server_only`, you must add the onLineItemsChange event handler when initializing the Stripe Checkout client and manually update the line items from your server using the Stripe API.
	UpdateLineItems *string `form:"update_line_items" json:"update_line_items,omitempty"`
	// Determines which entity is allowed to update the shipping details.
	//
	// Default is `client_only`. Stripe Checkout client will automatically update the shipping details. If set to `server_only`, only your server is allowed to update the shipping details.
	//
...
type CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsLicenseFeeComponentParams struct {
	Quantity *int64 `form:"quantity" json:"quantity"`
}
type CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsParams struct {
	LicenseFeeComponent *CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsLicenseFeeComponentParams `form:"license_fee_component" json:"license_fee_component,omitempty"`
	Type                *string                                                                                                 `form:"type" json:"type"`
}
type CheckoutSessionCheckoutItemPricingPlanSubscriptionItemParams struct {
	ComponentConfigurations map[string]*CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsParams `form:"component_configurations" json:"component_configurations,omitempty"`
	Metadata                map[string]string                                                                               `form:"metadata" json:"metadata,omitempty"`
...
// AddMetadata adds a new key-value pair to the Metadata.
func (p *CheckoutSessionCheckoutItemPricingPlanSubscriptionItemParams) AddMetadata(key string, value string) {
	if p.Metadata == nil {
		p.Metadata = make(map[string]string)
	}
...
type CheckoutSessionCheckoutItemParams struct {
	PricingPlanSubscriptionItem *CheckoutSessionCheckoutItemPricingPlanSubscriptionItemParams `form:"pricing_plan_subscription_item" json:"pricing_plan_subscription_item,omitempty"`
	RateCardSubscriptionItem    *CheckoutSessionCheckoutItemRateCardSubscriptionItemParams    `form:"rate_card_subscription_item" json:"rate_card_subscription_item,omitempty"`
	Type                        *string                                                       `form:"type" json:"type"`
}
...
type CheckoutSessionParams struct {
	...
	CheckoutItems []*CheckoutSessionCheckoutItemParams `form:"checkout_items" json:"checkout_items,omitempty"`
...
type CheckoutSessionApproveParams struct {
	...
	ReturnURL *string `form:"return_url" json:"return_url,omitempty"`
	// A subset of parameters to be passed to subscription creation for Checkout Sessions in `subscription` mode.
	SubscriptionData *CheckoutSessionApproveSubscriptionDataParams `form:"subscription_data" json:"subscription_data,omitempty"`
}
...
type CheckoutSessionCreateDiscountParams struct {
	...
	Coupon *string `form:"coupon" json:"coupon,omitempty"`
	// Data used to generate a new [Coupon](https://docs.stripe.com/api/coupon) object inline. One of `coupon` or `coupon_data` is required when updating discounts.
	CouponData *CheckoutSessionCreateDiscountCouponDataParams `form:"coupon_data" json:"coupon_data,omitempty"`
	// The ID of a promotion code to apply to this Session.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
}
...
type CheckoutSessionCreatePermissionsParams struct {
	// Permissions for updating the Checkout Session.
	Update *CheckoutSessionCreatePermissionsUpdateParams `form:"update" json:"update,omitempty"`
	// Determines which entity is allowed to update the discounts (coupons or promotion codes) that apply to this session.
	//
	// Default is `client_only`. Stripe Checkout client will automatically handle discount updates. If set to `server_only`, only your server is allowed to update discounts.
	UpdateDiscounts *string `form:"update_discounts" json:"update_discounts,omitempty"`
...
type CheckoutSessionCreateCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsLicenseFeeComponentParams struct {
	Quantity *int64 `form:"quantity" json:"quantity"`
}
type CheckoutSessionCreateCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsParams struct {
	LicenseFeeComponent *CheckoutSessionCreateCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsLicenseFeeComponentParams `form:"license_fee_component" json:"license_fee_component,omitempty"`
	Type                *string                                                                                                       `form:"type" json:"type"`
}
type CheckoutSessionCreateCheckoutItemPricingPlanSubscriptionItemParams struct {
	ComponentConfigurations map[string]*CheckoutSessionCreateCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsParams `form:"component_configurations" json:"component_configurations,omitempty"`
	Metadata                map[string]string                                                                                     `form:"metadata" json:"metadata,omitempty"`
	PricingPlan             *string                                                                                               `form:"pricing_plan" json:"pricing_plan"`
	PricingPlanVersion      *string                                                                                               `form:"pricing_plan_version" json:"pricing_plan_version,omitempty"`
}
...
// AddMetadata adds a new key-value pair to the Metadata.
func (p *CheckoutSessionCreateCheckoutItemPricingPlanSubscriptionItemParams) AddMetadata(key string, value string) {
	if p.Metadata == nil {
		p.Metadata = make(map[string]string)
	}
...
type CheckoutSessionCreateCheckoutItemParams struct {
	PricingPlanSubscriptionItem *CheckoutSessionCreateCheckoutItemPricingPlanSubscriptionItemParams `form:"pricing_plan_subscription_item" json:"pricing_plan_subscription_item,omitempty"`
	RateCardSubscriptionItem    *CheckoutSessionCreateCheckoutItemRateCardSubscriptionItemParams    `form:"rate_card_subscription_item" json:"rate_card_subscription_item,omitempty"`
	Type                        *string                                                             `form:"type" json:"type"`
}
...
type CheckoutSessionCreateParams struct {
	...
	// If set, Checkout displays a back button and customers will be directed to this URL if they decide to cancel payment and return to your website. This parameter is not allowed if ui_mode is `embedded_page` or `elements`.
	CancelURL     *string                                    `form:"cancel_url" json:"cancel_url,omitempty"`
	CheckoutItems []*CheckoutSessionCreateCheckoutItemParams `form:"checkout_items" json:"checkout_items,omitempty"`
	// A unique string to reference the Checkout Session. This can be a
	// customer ID, a cart ID, or similar, and can be used to reconcile the
	// session with your internal systems.
	ClientReferenceID *string `form:"client_reference_id" json:"client_reference_id,omitempty"`
...
type CheckoutSessionUpdateAutomaticTaxParams struct {
	// The account that's liable for tax. If set, the business address and tax registrations required to perform the tax calculation are loaded from this account. The tax transaction is returned in the report of the connected account.
	Liability *CheckoutSessionUpdateAutomaticTaxLiabilityParams `form:"liability" json:"liability,omitempty"`
}
...
type CheckoutSessionUpdateDiscountParams struct {
	...
	Coupon *string `form:"coupon" json:"coupon,omitempty"`
	// Data used to generate a new [Coupon](https://docs.stripe.com/api/coupon) object inline. One of `coupon` or `coupon_data` is required when updating discounts.
	CouponData *CheckoutSessionUpdateDiscountCouponDataParams `form:"coupon_data" json:"coupon_data,omitempty"`
}
...
type CheckoutSessionUpdateInvoiceCreationInvoiceDataParams struct {
	// The connected account that issues the invoice. The invoice is presented with the branding and support information of the specified account.
	Issuer *CheckoutSessionUpdateInvoiceCreationInvoiceDataIssuerParams `form:"issuer" json:"issuer,omitempty"`
}

// Generate a post-purchase Invoice for one-time payments.
type CheckoutSessionUpdateInvoiceCreationParams struct {
	// Parameters passed when creating invoices for payment-mode Checkout Sessions.
	InvoiceData *CheckoutSessionUpdateInvoiceCreationInvoiceDataParams `form:"invoice_data" json:"invoice_data,omitempty"`
}
...
type CheckoutSessionUpdateParams struct {
	...
	Expand []*string `form:"expand" json:"expand,omitempty"`
	// Generate a post-purchase Invoice for one-time payments.
	InvoiceCreation *CheckoutSessionUpdateInvoiceCreationParams `form:"invoice_creation" json:"invoice_creation,omitempty"`
	// A list of items the customer is purchasing.
	//
	// When updating line items, you must retransmit the entire array of line items.
	//
	...
	// A subset of parameters to be passed to subscription creation for Checkout Sessions in `subscription` mode.
	SubscriptionData *CheckoutSessionUpdateSubscriptionDataParams `form:"subscription_data" json:"subscription_data,omitempty"`
...
// Specifies an interval for how often to bill for any pending invoice items.
type CheckoutSessionItemSubscriptionPendingInvoiceItemInterval struct {
	// Specifies invoicing frequency. Either `day`, `week`, `month` or `year`.
	Interval CheckoutSessionItemSubscriptionPendingInvoiceItemIntervalInterval `json:"interval"`
	// The number of intervals between invoices. For example, `interval=month` and `interval_count=3` bills every 3 months. Maximum of one year interval allowed (1 year, 12 months, or 52 weeks).
...
// Settings related to subscription trials.
type CheckoutSessionItemSubscriptionTrialSettings struct {
	// Defines how a subscription behaves when a free trial ends.
...
type CheckoutSessionItemSubscription struct {
	...
	Description string `json:"description"`
	// The items in the subscription.
	Items []*CheckoutSessionItemSubscriptionItem `json:"items"`
	// Set of key-value pairs attached to the subscription.
	Metadata map[string]string `json:"metadata"`
	// Specifies an interval for how often to bill for any pending invoice items.
	PendingInvoiceItemInterval *CheckoutSessionItemSubscriptionPendingInvoiceItemInterval `json:"pending_invoice_item_interval"`
	// Determines how to handle prorations when the subscription is updated.
	ProrationBehavior CheckoutSessionItemSubscriptionProrationBehavior `json:"proration_behavior"`
	...
	// Settings related to subscription trials.
	TrialSettings *CheckoutSessionItemSubscriptionTrialSettings `json:"trial_settings"`
}
...
type CheckoutSessionPaymentMethodOptionsCard struct {
	...
	// Request ability to [capture beyond the standard authorization validity window](https://docs.stripe.com/payments/extended-authorization) for this CheckoutSession.
	RequestDecrementalAuthorization CheckoutSessionPaymentMethodOptionsCardRequestDecrementalAuthorization `json:"request_decremental_authorization,omitempty"`
	// Request ability to [capture beyond the standard authorization validity window](https://docs.stripe.com/payments/extended-authorization) for this CheckoutSession.
...
type CheckoutSessionPaymentMethodOptionsUSBankAccountFinancialConnectionsManualEntry struct {
	// Settings for configuring manual entry of account details.
	Mode CheckoutSessionPaymentMethodOptionsUSBankAccountFinancialConnectionsManualEntryMode `json:"mode,omitempty"`
}
type CheckoutSessionPaymentMethodOptionsUSBankAccountFinancialConnections struct {
	...
	ManualEntry *CheckoutSessionPaymentMethodOptionsUSBankAccountFinancialConnectionsManualEntry `json:"manual_entry,omitempty"`
	// The list of permissions to request. The `payment_method` permission must be included.
...
type CheckoutSessionPermissionsUpdate struct {
	...
	//
	// When set to `server_only`, you must add the onLineItemsChange event handler when initializing the Stripe Checkout client and manually update the line items from your server using the Stripe API.
	LineItems CheckoutSessionPermissionsUpdateLineItems `json:"line_items,omitempty"`
	// Determines which entity is allowed to update the shipping details.
	//
	// Default is `client_only`. Stripe Checkout client will automatically update the shipping details. If set to `server_only`, only your server is allowed to update the shipping details.
	//
...
type CheckoutSessionPermissions struct {
	// Permissions for updating the Checkout Session.
	Update *CheckoutSessionPermissionsUpdate `json:"update,omitempty"`
	// Determines which entity is allowed to update the line items.
	//
	// Default is `client_only`. Stripe Checkout client will automatically update the line items. If set to `server_only`, only your server is allowed to update the line items.
	//
	// When set to `server_only`, you must add the onLineItemsChange event handler when initializing the Stripe Checkout client and manually update the line items from your server using the Stripe API.
	UpdateLineItems CheckoutSessionPermissionsUpdateLineItems `json:"update_line_items,omitempty"`
	// Determines which entity is allowed to update the shipping details.
	//
	// Default is `client_only`. Stripe Checkout client will automatically update the shipping details. If set to `server_only`, only your server is allowed to update the shipping details.
	//
...
type CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsLicenseFeeComponent struct {
	Quantity int64 `json:"quantity"`
}
type CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurations struct {
	LicenseFeeComponent *CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsLicenseFeeComponent `json:"license_fee_component,omitempty"`
	Type                CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurationsType                 `json:"type"`
}
type CheckoutSessionCheckoutItemPricingPlanSubscriptionItem struct {
	BillingCadence          string                                                                                    `json:"billing_cadence,omitempty"`
	ComponentConfigurations map[string]*CheckoutSessionCheckoutItemPricingPlanSubscriptionItemComponentConfigurations `json:"component_configurations"`
	Metadata                map[string]string                                                                         `json:"metadata"`
...
type CheckoutSessionCheckoutItem struct {
	PricingPlanSubscriptionItem *CheckoutSessionCheckoutItemPricingPlanSubscriptionItem `json:"pricing_plan_subscription_item,omitempty"`
	RateCardSubscriptionItem    *CheckoutSessionCheckoutItemRateCardSubscriptionItem    `json:"rate_card_subscription_item,omitempty"`
...
type CheckoutSession struct {
	...
	CheckoutItems []*CheckoutSessionCheckoutItem `json:"checkout_items,omitempty"`
	// A unique string to reference the Checkout Session. This can be a
	// customer ID, a cart ID, or similar, and can be used to reconcile the
	// Session with your internal systems.
	...
	// The customer's pending attempt to pay that requires your approval. Contains information about the customer and their payment details.
	CurrentAttempt *CheckoutSessionCurrentAttempt `json:"current_attempt,omitempty"`
