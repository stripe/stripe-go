...
func Close(id string, params *stripe.TestHelpersIssuingDisputeCloseParams) (*stripe.IssuingDispute, error) {
...
//
// [migration guide]: https://github.com/stripe/stripe-go/wiki/Migration-guide-for-Stripe-Client
func (c Client) Close(id string, params *stripe.TestHelpersIssuingDisputeCloseParams) (*stripe.IssuingDispute, error) {
	path := stripe.FormatURLPath("/v1/test_helpers/issuing/disputes/%s/close", id)
...
//
// [migration guide]: https://github.com/stripe/stripe-go/wiki/Migration-guide-for-Stripe-Client
func (c Client) SimulateNetworkLifecyclePreArbitrationResponse(id string, params *stripe.TestHelpersIssuingDisputeSimulateNetworkLifecyclePreArbitrationResponseParams) (*stripe.IssuingDispute, error) {
	path := stripe.FormatURLPath(
		"/v1/test_helpers/issuing/disputes/%s/simulate_network_lifecycle_pre_arbitration_response", id)
	dispute := &stripe.IssuingDispute{}
	err := c.B.Call(http.MethodPost, path, c.Key, params, dispute)
	return dispute, err
}
