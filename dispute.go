...
type DisputeParams struct {
	...
	AmountToCounter *int64 `form:"amount_to_counter" json:"amount_to_counter,omitempty"`
	// Evidence to upload, to respond to a dispute. Updating any field in the hash will submit all fields in the hash for review. The combined character count of all fields is limited to 150,000.
	Evidence *DisputeEvidenceParams `form:"evidence" json:"evidence,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
	// Intended submission method for the dispute.
	IntendedSubmissionMethod *string `form:"intended_submission_method" json:"intended_submission_method,omitempty"`
...
type DisputeEvidenceDetails struct {
	...
	// Whether the dispute was submitted manually, with Smart Disputes, or not submitted.
	SubmissionMethod DisputeEvidenceDetailsSubmissionMethod `json:"submission_method,omitempty"`
}
...
type Dispute struct {
	...
	AmountToCounter int64 `json:"amount_to_counter,omitempty"`
	...
	ID string `json:"id"`
	// Intended submission method for the dispute.
	IntendedSubmissionMethod DisputeIntendedSubmissionMethod `json:"intended_submission_method,omitempty"`
	...
	SmartDisputes *DisputeSmartDisputes `json:"smart_disputes,omitempty"`
	// The current status of a dispute. Possible values include:`warning_needs_response`, `warning_under_review`, `warning_closed`, `needs_response`, `under_review`, `won`, `lost`, or `prevented`.
