...
// IsValid checks if the SubscriptionCollectionMethod value is valid
func (s SubscriptionCollectionMethod) IsValid() bool {
	switch s {
	case SubscriptionCollectionMethodChargeAutomatically,
...
// SubscriptionPaymentBehavior controls the behavior of subscription creation/update in case of a failed payment.
...
const (
	...
	SubscriptionPaymentBehaviorDefaultIncomplete   SubscriptionPaymentBehavior = "default_incomplete"
...
// IsValid checks if the SubscriptionPaymentBehavior value is valid
func (s SubscriptionPaymentBehavior) IsValid() bool {
	switch s {
	case SubscriptionPaymentBehaviorAllowIncomplete,
		SubscriptionPaymentBehaviorDefaultIncomplete,
		SubscriptionPaymentBehaviorErrorIfIncomplete,
		SubscriptionPaymentBehaviorPendingIfIncomplete:
		return true
	default:
		return false
	}
...
// SubscriptionProrationBehavior determines how proration is handled for subscription changes.
...
// IsValid checks if the SubscriptionProrationBehavior value is valid
func (s SubscriptionProrationBehavior) IsValid() bool {
	switch s {
	case SubscriptionProrationBehaviorAlwaysInvoice,
...
type SubscriptionParams struct {
	...
	// Use stripe.String(stripe.SubscriptionPaymentBehaviorAllowIncomplete) for type-safe usage.
	PaymentBehavior *SubscriptionPaymentBehavior `form:"payment_behavior"`
