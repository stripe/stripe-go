...
const (
	...
	SubscriptionAutomaticTaxLiabilityTypeApplication SubscriptionAutomaticTaxLiabilityType = "application"
...
const (
	...
	SubscriptionInvoiceSettingsIssuerTypeApplication SubscriptionInvoiceSettingsIssuerType = "application"
...
const (
	...
	SubscriptionPaymentSettingsPaymentMethodTypeSatispay           SubscriptionPaymentSettingsPaymentMethodType = "satispay"
	...
	SubscriptionPaymentSettingsPaymentMethodTypeSequra             SubscriptionPaymentSettingsPaymentMethodType = "sequra"
...
// List of values that SubscriptionTrialSettingsEndBehaviorBillingCycleAnchor can take
const (
	SubscriptionTrialSettingsEndBehaviorBillingCycleAnchorNow       SubscriptionTrialSettingsEndBehaviorBillingCycleAnchor = "now"
	SubscriptionTrialSettingsEndBehaviorBillingCycleAnchorUnchanged SubscriptionTrialSettingsEndBehaviorBillingCycleAnchor = "unchanged"
)
...
type SubscriptionAddInvoiceItemDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionAddInvoiceItemDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
...
type SubscriptionAddInvoiceItemDiscountParams struct {
	...
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionAddInvoiceItemDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
...
type SubscriptionDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
type SubscriptionDiscountSettingsServicePeriodAnchorConfigCustomParams struct {
...
type SubscriptionDiscountSettingsServicePeriodAnchorConfigParams struct {
	// Anchor the service period to a custom date. Type must be `custom` to specify.
	Custom *SubscriptionDiscountSettingsServicePeriodAnchorConfigCustomParams `form:"custom" json:"custom,omitempty"`
	// The type of service period anchor config. Defaults to `subscription_service_cycle_anchor` if omitted.
	Type *string `form:"type" json:"type,omitempty"`
}

// Settings for discount application including service period anchoring.
type SubscriptionDiscountSettingsParams struct {
	// Configures service period cycle anchoring.
	ServicePeriodAnchorConfig *SubscriptionDiscountSettingsServicePeriodAnchorConfigParams `form:"service_period_anchor_config" json:"service_period_anchor_config,omitempty"`
...
type SubscriptionDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
	// Settings for discount application including service period anchoring.
	Settings *SubscriptionDiscountSettingsParams `form:"settings" json:"settings,omitempty"`
}

// A list of up to 4 custom fields to be displayed on the invoice.
type SubscriptionInvoiceSettingsCustomFieldParams struct {
...
type SubscriptionInvoiceSettingsParams struct {
	...
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*SubscriptionInvoiceSettingsCustomFieldParams `form:"custom_fields" json:"custom_fields,omitempty"`
...
const (
	...
	SubscriptionInvoiceSettingsParamsUnsetFieldCustomFields  SubscriptionInvoiceSettingsParamsUnsetField = "custom_fields"
	SubscriptionInvoiceSettingsParamsUnsetFieldDescription   SubscriptionInvoiceSettingsParamsUnsetField = "description"
	SubscriptionInvoiceSettingsParamsUnsetFieldFooter        SubscriptionInvoiceSettingsParamsUnsetField = "footer"
)
...
type SubscriptionPaymentSettingsPaymentMethodOptionsParams struct {
	...
	// This sub-hash contains details about the Indonesia bank transfer payment method options to pass to the invoice's PaymentIntent.
	IDBankTransfer *SubscriptionPaymentSettingsPaymentMethodOptionsIDBankTransferParams `form:"id_bank_transfer" json:"id_bank_transfer,omitempty"`
	// This sub-hash contains details about the Konbini payment method options to pass to the invoice's PaymentIntent.
...
type SubscriptionPauseBillForParams struct {
	// Controls when to bill for metered usage in the current period. Defaults to `{ type: "now" }`.
	OutstandingUsageThrough *SubscriptionPauseBillForOutstandingUsageThroughParams `form:"outstanding_usage_through" json:"outstanding_usage_through,omitempty"`
	// Controls when to credit for unused time on licensed items. Defaults to `{ type: "now" }`.
	UnusedTimeFrom *SubscriptionPauseBillForUnusedTimeFromParams `form:"unused_time_from" json:"unused_time_from,omitempty"`
}
...
type SubscriptionPauseParams struct {
	Params `form:"*"`
	// Controls what to bill for when pausing the subscription.
	BillFor *SubscriptionPauseBillForParams `form:"bill_for" json:"bill_for,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
...
type SubscriptionUpdateAddInvoiceItemDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionUpdateAddInvoiceItemDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
type SubscriptionUpdateAddInvoiceItemDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionUpdateAddInvoiceItemDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
}
...
type SubscriptionUpdateDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionUpdateDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
// Anchor the service period to a custom date. Type must be `custom` to specify.
type SubscriptionUpdateDiscountSettingsServicePeriodAnchorConfigCustomParams struct {
	// The day of the month the anchor should be. Ranges from 1 to 31.
	DayOfMonth *int64 `form:"day_of_month" json:"day_of_month"`
	// The hour of the day the anchor should be. Ranges from 0 to 23.
	Hour *int64 `form:"hour" json:"hour,omitempty"`
...
// Configures service period cycle anchoring.
type SubscriptionUpdateDiscountSettingsServicePeriodAnchorConfigParams struct {
	// Anchor the service period to a custom date. Type must be `custom` to specify.
	Custom *SubscriptionUpdateDiscountSettingsServicePeriodAnchorConfigCustomParams `form:"custom" json:"custom,omitempty"`
	// The type of service period anchor config. Defaults to `subscription_service_cycle_anchor` if omitted.
	Type *string `form:"type" json:"type,omitempty"`
}

// Settings for discount application including service period anchoring.
type SubscriptionUpdateDiscountSettingsParams struct {
	// Configures service period cycle anchoring.
	ServicePeriodAnchorConfig *SubscriptionUpdateDiscountSettingsServicePeriodAnchorConfigParams `form:"service_period_anchor_config" json:"service_period_anchor_config,omitempty"`
	// The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `now` if omitted.
	StartDate *string `form:"start_date" json:"start_date,omitempty"`
}
...
type SubscriptionUpdateDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionUpdateDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
	// Settings for discount application including service period anchoring.
	Settings *SubscriptionUpdateDiscountSettingsParams `form:"settings" json:"settings,omitempty"`
}

// A list of up to 4 custom fields to be displayed on the invoice.
type SubscriptionUpdateInvoiceSettingsCustomFieldParams struct {
	// The name of the custom field. This may be up to 40 characters.
	Name *string `form:"name" json:"name"`
	// The value of the custom field. This may be up to 140 characters.
	Value *string `form:"value" json:"value"`
...
type SubscriptionUpdateInvoiceSettingsParams struct {
	...
	AccountTaxIDs []*string `form:"account_tax_ids" json:"account_tax_ids,omitempty"`
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*SubscriptionUpdateInvoiceSettingsCustomFieldParams `form:"custom_fields" json:"custom_fields,omitempty"`
	// An arbitrary string attached to the object. Often useful for displaying to users.
	Description *string `form:"description" json:"description,omitempty"`
	// Footer to be displayed on the invoice.
	Footer *string `form:"footer" json:"footer,omitempty"`
...
const (
	...
	SubscriptionUpdateInvoiceSettingsParamsUnsetFieldCustomFields  SubscriptionUpdateInvoiceSettingsParamsUnsetField = "custom_fields"
	SubscriptionUpdateInvoiceSettingsParamsUnsetFieldDescription   SubscriptionUpdateInvoiceSettingsParamsUnsetField = "description"
	SubscriptionUpdateInvoiceSettingsParamsUnsetFieldFooter        SubscriptionUpdateInvoiceSettingsParamsUnsetField = "footer"
)
...
type SubscriptionUpdateItemDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionUpdateItemDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
// Anchor the service period to a custom date. Type must be `custom` to specify.
type SubscriptionUpdateItemDiscountSettingsServicePeriodAnchorConfigCustomParams struct {
	// The day of the month the anchor should be. Ranges from 1 to 31.
	DayOfMonth *int64 `form:"day_of_month" json:"day_of_month"`
	// The hour of the day the anchor should be. Ranges from 0 to 23.
	Hour *int64 `form:"hour" json:"hour,omitempty"`
...
// Configures service period cycle anchoring.
type SubscriptionUpdateItemDiscountSettingsServicePeriodAnchorConfigParams struct {
	// Anchor the service period to a custom date. Type must be `custom` to specify.
	Custom *SubscriptionUpdateItemDiscountSettingsServicePeriodAnchorConfigCustomParams `form:"custom" json:"custom,omitempty"`
	// The type of service period anchor config. Defaults to `subscription_service_cycle_anchor` if omitted.
	Type *string `form:"type" json:"type,omitempty"`
}

// Settings for discount application including service period anchoring.
type SubscriptionUpdateItemDiscountSettingsParams struct {
	// Configures service period cycle anchoring.
	ServicePeriodAnchorConfig *SubscriptionUpdateItemDiscountSettingsServicePeriodAnchorConfigParams `form:"service_period_anchor_config" json:"service_period_anchor_config,omitempty"`
	// The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `now` if omitted.
	StartDate *string `form:"start_date" json:"start_date,omitempty"`
}
...
type SubscriptionUpdateItemDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionUpdateItemDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
	// Settings for discount application including service period anchoring.
	Settings *SubscriptionUpdateItemDiscountSettingsParams `form:"settings" json:"settings,omitempty"`
}
...
type SubscriptionUpdateItemParams struct {
	...
	ClearUsage *bool `form:"clear_usage" json:"clear_usage,omitempty"`
	// The trial offer to apply to this subscription item.
	CurrentTrial *SubscriptionUpdateItemCurrentTrialParams `form:"current_trial" json:"current_trial,omitempty"`
	// A flag that, if set to `true`, will delete the specified item.
	Deleted *bool `form:"deleted" json:"deleted,omitempty"`
	// The coupons to redeem into discounts for the subscription item.
...
type SubscriptionUpdatePaymentSettingsPaymentMethodOptionsParams struct {
	...
	// This sub-hash contains details about the Indonesia bank transfer payment method options to pass to the invoice's PaymentIntent.
	IDBankTransfer *SubscriptionUpdatePaymentSettingsPaymentMethodOptionsIDBankTransferParams `form:"id_bank_transfer" json:"id_bank_transfer,omitempty"`
	// This sub-hash contains details about the Konbini payment method options to pass to the invoice's PaymentIntent.
...
type SubscriptionCreateAddInvoiceItemDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionCreateAddInvoiceItemDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
type SubscriptionCreateAddInvoiceItemDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionCreateAddInvoiceItemDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
}
...
type SubscriptionCreateDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionCreateDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
// Anchor the service period to a custom date. Type must be `custom` to specify.
type SubscriptionCreateDiscountSettingsServicePeriodAnchorConfigCustomParams struct {
	// The day of the month the anchor should be. Ranges from 1 to 31.
	DayOfMonth *int64 `form:"day_of_month" json:"day_of_month"`
	// The hour of the day the anchor should be. Ranges from 0 to 23.
	Hour *int64 `form:"hour" json:"hour,omitempty"`
...
// Configures service period cycle anchoring.
type SubscriptionCreateDiscountSettingsServicePeriodAnchorConfigParams struct {
	// Anchor the service period to a custom date. Type must be `custom` to specify.
	Custom *SubscriptionCreateDiscountSettingsServicePeriodAnchorConfigCustomParams `form:"custom" json:"custom,omitempty"`
	// The type of service period anchor config. Defaults to `subscription_service_cycle_anchor` if omitted.
	Type *string `form:"type" json:"type,omitempty"`
}

// Settings for discount application including service period anchoring.
type SubscriptionCreateDiscountSettingsParams struct {
	// Configures service period cycle anchoring.
	ServicePeriodAnchorConfig *SubscriptionCreateDiscountSettingsServicePeriodAnchorConfigParams `form:"service_period_anchor_config" json:"service_period_anchor_config,omitempty"`
	// The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `now` if omitted.
	StartDate *string `form:"start_date" json:"start_date,omitempty"`
}
...
type SubscriptionCreateDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionCreateDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
	// Settings for discount application including service period anchoring.
	Settings *SubscriptionCreateDiscountSettingsParams `form:"settings" json:"settings,omitempty"`
}

// A list of up to 4 custom fields to be displayed on the invoice.
type SubscriptionCreateInvoiceSettingsCustomFieldParams struct {
	// The name of the custom field. This may be up to 40 characters.
	Name *string `form:"name" json:"name"`
	// The value of the custom field. This may be up to 140 characters.
	Value *string `form:"value" json:"value"`
...
type SubscriptionCreateInvoiceSettingsParams struct {
	...
	AccountTaxIDs []*string `form:"account_tax_ids" json:"account_tax_ids,omitempty"`
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*SubscriptionCreateInvoiceSettingsCustomFieldParams `form:"custom_fields" json:"custom_fields,omitempty"`
	// An arbitrary string attached to the object. Often useful for displaying to users.
	Description *string `form:"description" json:"description,omitempty"`
	// Footer to be displayed on the invoice.
	Footer *string `form:"footer" json:"footer,omitempty"`
...
const (
	...
	SubscriptionCreateInvoiceSettingsParamsUnsetFieldCustomFields  SubscriptionCreateInvoiceSettingsParamsUnsetField = "custom_fields"
)
...
type SubscriptionCreateItemDiscountDiscountEndParams struct {
	// Time span for the redeemed discount.
	Duration *SubscriptionCreateItemDiscountDiscountEndDurationParams `form:"duration" json:"duration,omitempty"`
	// A precise Unix timestamp for the discount to end. Must be in the future.
	Timestamp *int64 `form:"timestamp" json:"timestamp,omitempty"`
	// The type of calculation made to determine when the discount ends.
	Type *string `form:"type" json:"type"`
...
// Anchor the service period to a custom date. Type must be `custom` to specify.
type SubscriptionCreateItemDiscountSettingsServicePeriodAnchorConfigCustomParams struct {
	// The day of the month the anchor should be. Ranges from 1 to 31.
	DayOfMonth *int64 `form:"day_of_month" json:"day_of_month"`
	// The hour of the day the anchor should be. Ranges from 0 to 23.
	Hour *int64 `form:"hour" json:"hour,omitempty"`
...
// Configures service period cycle anchoring.
type SubscriptionCreateItemDiscountSettingsServicePeriodAnchorConfigParams struct {
	// Anchor the service period to a custom date. Type must be `custom` to specify.
	Custom *SubscriptionCreateItemDiscountSettingsServicePeriodAnchorConfigCustomParams `form:"custom" json:"custom,omitempty"`
	// The type of service period anchor config. Defaults to `subscription_service_cycle_anchor` if omitted.
	Type *string `form:"type" json:"type,omitempty"`
}

// Settings for discount application including service period anchoring.
type SubscriptionCreateItemDiscountSettingsParams struct {
	// Configures service period cycle anchoring.
	ServicePeriodAnchorConfig *SubscriptionCreateItemDiscountSettingsServicePeriodAnchorConfigParams `form:"service_period_anchor_config" json:"service_period_anchor_config,omitempty"`
	// The start date of the discount's service period when applying a coupon or promotion code with a service period duration. Defaults to `now` if omitted.
	StartDate *string `form:"start_date" json:"start_date,omitempty"`
}
...
type SubscriptionCreateItemDiscountParams struct {
	...
	Discount *string `form:"discount" json:"discount,omitempty"`
	// Details to determine how long the discount should be applied for.
	DiscountEnd *SubscriptionCreateItemDiscountDiscountEndParams `form:"discount_end" json:"discount_end,omitempty"`
	// ID of the promotion code to create a new discount for.
	PromotionCode *string `form:"promotion_code" json:"promotion_code,omitempty"`
	// Settings for discount application including service period anchoring.
	Settings *SubscriptionCreateItemDiscountSettingsParams `form:"settings" json:"settings,omitempty"`
}
...
type SubscriptionCreateItemParams struct {
	...
	// The trial offer to apply to this subscription item.
	CurrentTrial *SubscriptionCreateItemCurrentTrialParams `form:"current_trial" json:"current_trial,omitempty"`
	// The coupons to redeem into discounts for the subscription item.
	...
	TaxRates []*string `form:"tax_rates" json:"tax_rates,omitempty"`
	// Define options to configure the trial on the subscription item.
	Trial       *SubscriptionCreateItemTrialParams       `form:"trial" json:"trial,omitempty"`
...
type SubscriptionCreatePaymentSettingsPaymentMethodOptionsParams struct {
	...
	// This sub-hash contains details about the Indonesia bank transfer payment method options to pass to the invoice's PaymentIntent.
	IDBankTransfer *SubscriptionCreatePaymentSettingsPaymentMethodOptionsIDBankTransferParams `form:"id_bank_transfer" json:"id_bank_transfer,omitempty"`
	// This sub-hash contains details about the Konbini payment method options to pass to the invoice's PaymentIntent.
...
type SubscriptionCreateParams struct {
	...
	// If specified, the invoicing for the given billing cycle iterations will be processed now.
	Prebilling *SubscriptionCreatePrebillingParams `form:"prebilling" json:"prebilling,omitempty"`
...
// A list of up to 4 custom fields to be displayed on the invoice.
type SubscriptionInvoiceSettingsCustomField struct {
...
type SubscriptionInvoiceSettings struct {
	...
	// A list of up to 4 custom fields to be displayed on the invoice.
	CustomFields []*SubscriptionInvoiceSettingsCustomField `json:"custom_fields"`
	// An arbitrary string attached to the object. Often useful for displaying to users.
...
type SubscriptionPaymentSettingsPaymentMethodOptions struct {
	...
	// This sub-hash contains details about the Indonesia bank transfer payment method options to pass to invoices created by the subscription.
	IDBankTransfer *SubscriptionPaymentSettingsPaymentMethodOptionsIDBankTransfer `json:"id_bank_transfer,omitempty"`
	// This sub-hash contains details about the Konbini payment method options to pass to invoices created by the subscription.
...
type SubscriptionPendingUpdate struct {
	...
	PrebillingIterations int64 `json:"prebilling_iterations,omitempty"`
...
type SubscriptionPrebilling struct {
	...
	// Whether to cancel or preserve `prebilling` if the subscription is updated during the prebilled period.
	UpdateBehavior SubscriptionPrebillingUpdateBehavior `json:"update_behavior,omitempty"`
}
...
type Subscription struct {
	...
	// Details of the most recent price migration that failed for the subscription.
	LastPriceMigrationError *SubscriptionLastPriceMigrationError `json:"last_price_migration_error,omitempty"`
	...
	// Time period and invoice for a Subscription billed in advance.
	Prebilling         *SubscriptionPrebilling         `json:"prebilling,omitempty"`
