...
// Returns a list of credit notes.
func (c v1CreditNoteService) ListWithPage(ctx context.Context, listParams *CreditNoteListParams) *V1List[*CreditNote] {
	if listParams == nil {
...
func (c v1CreditNoteService) ListLines(ctx context.Context, listParams *CreditNoteListLinesParams) Seq2[*CreditNoteLineItem, error] {
	return c.ListLinesWithPage(ctx, listParams).All()
}

// When retrieving a credit note, you'll get a lines property containing the first handful of those items. There is also a URL where you can retrieve the full (paginated) list of line items.
func (c v1CreditNoteService) ListLinesWithPage(ctx context.Context, listParams *CreditNoteListLinesParams) *V1List[*CreditNoteLineItem] {
	if listParams == nil {
...
func (c v1CreditNoteService) PreviewLines(ctx context.Context, listParams *CreditNotePreviewLinesParams) Seq2[*CreditNoteLineItem, error] {
	return c.PreviewLinesWithPage(ctx, listParams).All()
}

// When retrieving a credit note preview, you'll get a lines property containing the first handful of those items. This URL you can retrieve the full (paginated) list of line items.
func (c v1CreditNoteService) PreviewLinesWithPage(ctx context.Context, listParams *CreditNotePreviewLinesParams) *V1List[*CreditNoteLineItem] {
	if listParams == nil {
