...
// A list of [all tax codes available](https://stripe.com/docs/tax/tax-categories) to add to Products in order to allow specific tax calculations.
func (c v1TaxCodeService) ListWithPage(ctx context.Context, listParams *TaxCodeListParams) *V1List[*TaxCode] {
	if listParams == nil {
		listParams = &TaxCodeListParams{}
	}
	listParams.Context = ctx
	return newV1List(ctx, listParams, func(ctx context.Context, p *Params, b *form.Values) (*V1Page[*TaxCode], error) {
		list := &V1Page[*TaxCode]{}
		if p == nil {
			p = &Params{}
		}
