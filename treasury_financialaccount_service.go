...
// Returns a list of FinancialAccounts.
func (c v1TreasuryFinancialAccountService) ListWithPage(ctx context.Context, listParams *TreasuryFinancialAccountListParams) *V1List[*TreasuryFinancialAccount] {
	if listParams == nil {
