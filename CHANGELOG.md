...
* [#2023](https://github.com/stripe/stripe-go/pull/2023) Update generated code for beta
  ...
  * Add support for `PriceData` on `CheckoutSessionLineItemsParams`
  * Change type of `CheckoutSessionLineItemsParams.Quantity` from `longInteger` to `emptyable(longInteger)`
