...
class SessionsController < ApplicationController
  ...
  def login_entrypoint
    render inline: <<-EOL
    <%= form_tag(stripe_auth_path, method: 'post', id: 'js-submission') %>
    <script>
  ...
  # routes are not autogenerated for omniauth authentication routes automatically
  helper_method :salesforce_auth_path
  helper_method :stripe_auth_path

  def salesforce_auth_path
    '/auth/salesforce'
  end

  def stripe_auth_path
    '/auth/stripe'
  end
