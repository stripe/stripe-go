...
type CouponParams struct {
	...
	Script *CouponScriptParams `form:"script" json:"script,omitempty"`
	// A hash specifying the service period for the coupon.
	ServicePeriod *CouponServicePeriodParams `form:"service_period" json:"service_period,omitempty"`
...
type CouponServicePeriodParams struct {
	...
	// Specifies the number of times the coupon is contiguously applied.
	Iterations *CouponServicePeriodIterationsParams `form:"iterations" json:"iterations,omitempty"`
}
...
type CouponCreateServicePeriodParams struct {
	...
	IntervalCount *int64 `form:"interval_count" json:"interval_count"`
	// Specifies the number of times the coupon is contiguously applied.
	Iterations *CouponCreateServicePeriodIterationsParams `form:"iterations" json:"iterations,omitempty"`
}
...
type CouponCreateParams struct {
	...
	RedeemBy *int64 `form:"redeem_by" json:"redeem_by,omitempty"`
	// Configuration of the [script](https://docs.stripe.com/billing/subscriptions/script-coupons) used to calculate the discount.
	Script *CouponCreateScriptParams `form:"script" json:"script,omitempty"`
	// A hash specifying the service period for the coupon.
	ServicePeriod *CouponCreateServicePeriodParams `form:"service_period" json:"service_period,omitempty"`
...
type Coupon struct {
	...
	// Configuration of the [script](https://docs.stripe.com/billing/subscriptions/script-coupons) used to calculate the discount.
	Script        *CouponScript        `json:"script,omitempty"`
