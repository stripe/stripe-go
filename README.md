# Go Stripe
[![Go Reference](https://pkg.go.dev/badge/github.com/stripe/stripe-go)](https://pkg.go.dev/github.com/stripe/stripe-go/v77)
...
``` go
import (
	"github.com/stripe/stripe-go/v77"
...
```bash
go get -u github.com/stripe/stripe-go/v77
```
...
import (
	"github.com/stripe/stripe-go/v77"
	"github.com/stripe/stripe-go/v77/client"
)
...
import (
	"github.com/stripe/stripe-go/v77"
	"github.com/stripe/stripe-go/v77/$resource$"
)
...
```
mockgen -destination=mocks/backend.go -package=mocks github.com/stripe/stripe-go/v77 Backend
```
...
```
go get -u github.com/stripe/stripe-go/v77@v77.1.0-beta.1
```
