...
func (c v1RefundService) MarshalBatchCancel(id string, params *RefundCancelParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1RefundService) MarshalBatchCreate(params *RefundCreateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1RefundService) List(ctx context.Context, listParams *RefundListParams) *V1List[*Refund] {
	...
	return newV1List(ctx, listParams, func(ctx context.Context, p *Params, b *form.Values) (*v1Page[*Refund], error) {
		list := &v1Page[*Refund]{}
		if p == nil {
			p = &Params{}
		}
