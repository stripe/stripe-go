...
// Package paymentintentamountdetailslineitem provides the /v1/payment_intents/{id}/amount_details_line_items APIs
...
// Client is used to invoke /v1/payment_intents/{id}/amount_details_line_items APIs.
