...
type V2BillingIntentActionApplyInvoiceDiscountRule struct {
	...
	InvoiceDiscountRule string `json:"invoice_discount_rule"`
	// Configuration for percentage off discount.
	PercentOff *V2BillingIntentActionApplyInvoiceDiscountRulePercentOff `json:"percent_off"`
	// Type of the discount rule.
...
type V2BillingIntentActionApply struct {
	// Details for applying a discount rule to future invoices.
	InvoiceDiscountRule *V2BillingIntentActionApplyInvoiceDiscountRule `json:"invoice_discount_rule"`
	// Type of the apply action details.
...
type V2BillingIntentActionDeactivateBillingDetails struct {
	// This controls the proration adjustment for the partial servicing period.
	ProrationBehavior V2BillingIntentActionDeactivateBillingDetailsProrationBehavior `json:"proration_behavior"`
}
...
type V2BillingIntentActionDeactivate struct {
	...
	// Details for deactivating a Pricing Plan Subscription.
	PricingPlanSubscriptionDetails *V2BillingIntentActionDeactivatePricingPlanSubscriptionDetails `json:"pricing_plan_subscription_details"`
	// Type of the action details.
...
type V2BillingIntentActionModifyBillingDetails struct {
	// This controls the proration adjustment for the partial servicing period.
	ProrationBehavior V2BillingIntentActionModifyBillingDetailsProrationBehavior `json:"proration_behavior"`
}
...
type V2BillingIntentActionModify struct {
	...
	// Details for modifying a Pricing Plan Subscription.
	PricingPlanSubscriptionDetails *V2BillingIntentActionModifyPricingPlanSubscriptionDetails `json:"pricing_plan_subscription_details"`
	// Type of the action details.
...
type V2BillingIntentActionSubscribeBillingDetails struct {
	// This controls the proration adjustment for the partial servicing period.
	ProrationBehavior V2BillingIntentActionSubscribeBillingDetailsProrationBehavior `json:"proration_behavior"`
}
...
type V2BillingIntentActionSubscribe struct {
	...
	// Details for subscribing to a Pricing Plan.
	PricingPlanSubscriptionDetails *V2BillingIntentActionSubscribePricingPlanSubscriptionDetails `json:"pricing_plan_subscription_details"`
	// Type of the action details.
	Type V2BillingIntentActionSubscribeType `json:"type"`
	// Details for subscribing to a V1 subscription.
	V1SubscriptionDetails *V2BillingIntentActionSubscribeV1SubscriptionDetails `json:"v1_subscription_details"`
}
type V2BillingIntentAction struct {
	APIResource
	// Details for an apply action.
	Apply *V2BillingIntentActionApply `json:"apply"`
	// Time at which the object was created.
	Created time.Time `json:"created"`
	// Details for a deactivate action.
	Deactivate *V2BillingIntentActionDeactivate `json:"deactivate"`
	// Unique identifier for the object.
	ID string `json:"id"`
	// Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
	Livemode bool `json:"livemode"`
	// Details for a modify action.
	Modify *V2BillingIntentActionModify `json:"modify"`
	// String representing the object's type. Objects of the same type share the same value of the object field.
	Object string `json:"object"`
	// Details for a remove action.
	Remove *V2BillingIntentActionRemove `json:"remove"`
	// Details for a subscribe action.
	Subscribe *V2BillingIntentActionSubscribe `json:"subscribe"`
	// Type of the Billing Intent Action.
