...
func (c v1CouponService) MarshalBatchCreate(params *CouponCreateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1CouponService) MarshalBatchDelete(id string, params *CouponDeleteParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1CouponService) MarshalBatchUpdate(id string, params *CouponUpdateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
