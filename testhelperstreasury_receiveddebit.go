...
type TestHelpersTreasuryReceivedDebitNetworkDetailsParams struct {
	// Optional fields for `ach`.
	ACH *TestHelpersTreasuryReceivedDebitNetworkDetailsACHParams `form:"ach" json:"ach,omitempty"`
...
type TestHelpersTreasuryReceivedDebitParams struct {
	...
	// Details about the network used for the ReceivedDebit.
	NetworkDetails *TestHelpersTreasuryReceivedDebitNetworkDetailsParams `form:"network_details" json:"network_details,omitempty"`
}
...
type TestHelpersTreasuryReceivedDebitCreateNetworkDetailsParams struct {
	// Optional fields for `ach`.
	ACH *TestHelpersTreasuryReceivedDebitCreateNetworkDetailsACHParams `form:"ach" json:"ach,omitempty"`
	// The type of flow that originated the ReceivedDebit.
	Type *string `form:"type" json:"type"`
}
...
type TestHelpersTreasuryReceivedDebitCreateParams struct {
	...
	Network *string `form:"network" json:"network"`
	// Details about the network used for the ReceivedDebit.
	NetworkDetails *TestHelpersTreasuryReceivedDebitCreateNetworkDetailsParams `form:"network_details" json:"network_details,omitempty"`
}
