...
func (p *ReserveHoldListParams) AddExpand(f string) {
...
// AddExpand appends a new field to expand.
func (p *ReserveHoldParams) AddExpand(f string) {
	p.Expand = append(p.Expand, &f)
}
...
// AddExpand appends a new field to expand.
func (p *ReserveHoldRetrieveParams) AddExpand(f string) {
	p.Expand = append(p.Expand, &f)
}
...
// ReserveHoldList is a list of Holds as retrieved from a list endpoint.
type ReserveHoldList struct {
	APIResource
	ListMeta
	Data []*ReserveHold `json:"data"`
}
