...
func (c v1TaxRateService) MarshalBatchCreate(params *TaxRateCreateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
...
func (c v1TaxRateService) MarshalBatchUpdate(id string, params *TaxRateUpdateParams) (string, error) {
	itemID, err := newUUID4()
	if err != nil {
		return "", err
	}
