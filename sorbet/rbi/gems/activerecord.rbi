...
class Arel::Attributes::Attribute < Anonymous_Struct_29
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_30
end
...
class ActiveRecord::Type::Time::Value < Anonymous_Delegator_31
end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_32
  def accessor; end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_33
  def pretty_print(pp); end
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_34
  def deserialize(value); end
  def encode_with(coder); end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_35
  def cast(value); end
