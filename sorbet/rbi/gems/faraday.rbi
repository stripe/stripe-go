...
class Anonymous_Faraday_Options_10 < Faraday::Options
  def bind; end
  def bind=(_); end
  def boundary; end
  def boundary=(_); end
...
class Faraday::RequestOptions < Anonymous_Faraday_Options_10
  def []=(key, value); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_11
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_12 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_12
...
class Anonymous_Faraday_Options_13 < Faraday::Options
  def builder; end
  def builder=(_); end
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_13
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_14
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
